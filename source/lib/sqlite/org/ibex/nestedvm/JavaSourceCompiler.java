...
public class JavaSourceCompiler extends Compiler {
   ...
   public JavaSourceCompiler(Seekable var1, String var2, Writer var3) throws IOException {
      super(var1, var2);
   ...
   protected void _go() throws Compiler.Exn, IOException {
      if (this.singleFloat) {
         ...
         for(int var7 = 1; var7 < 32; ++var7) {
            this.p("r" + var7 + "=state.r[" + var7 + "];");
         }

         for(int var8 = 0; var8 < 32; ++var8) {
            this.p("f" + var8 + "=state.f[" + var8 + "];");
         }
         ...
         for(int var9 = 1; var9 < 32; ++var9) {
            this.p("state.r[" + var9 + "]=r" + var9 + ";");
         }

         for(int var10 = 0; var10 < 32; ++var10) {
            this.p("state.f[" + var10 + "]=f" + var10 + ";");
         }
         ...
         if (this.supportCall) {
            ...
            this.p("static {");
            ++this.indent;
            ELF.Symbol[] var11 = this.elf.getSymtab().symbols;

            for(int var12 = 0; var12 < var11.length; ++var12) {
               ELF.Symbol var13 = var11[var12];
               if (var13.type == 2 && var13.binding == 1 && (var13.name.equals("_call_helper") || !var13.name.startsWith("_"))) {
                  this.p("symbols.put(\"" + var13.name + "\",new Integer(" + toHex(var13.addr) + "));");
               }
            }
         ...
         for(int var5 = var1 + var3; var1 < var5; var3 -= var6) {
            ...
            for(int var8 = 0; var8 < var6; var8 += 7) {
               ...
               for(int var15 = 0; var15 < 8; ++var15) {
                  char var16 = (char)((int)(var9 >>> 7 * (7 - var15) & 127L));
                  if (var16 == '\n') {
                     var7.append("\\n");
                  } else if (var16 == '\r') {
                     var7.append("\\r");
   ...
   private void emitInstruction(int var1, int var2, int var3) throws IOException, Compiler.Exn {
      if (var2 == -1) {
