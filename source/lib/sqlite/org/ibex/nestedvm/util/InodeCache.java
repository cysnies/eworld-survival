...
public class InodeCache {
   ...
   public final short get(Object var1) {
      ...
      if (this.size == this.maxSize) {
         ...
         if (this.size == 0) {
            this.lru = (short)var18;
         }

         ++this.size;
      }

      int var19 = var2 & 32767;

      label100:
      while(true) {
         var3 = var19 % this.totalSlots;
         var4 = var3;
         var5 = 1;
         var6 = true;

         short var20;
         for(var8 = -1; (var20 = this.reverse[var3]) != -1; var6 = !var6) {
            short var12 = this.inodes[var20];
            if (var12 == -2) {
               if (var8 == -1) {
                  var8 = var3;
               }
         ...
         this.keys[var18] = var1;
         this.reverse[var3] = (short)var18;
         this.inodes[var18] = (short)var19;
         if (this.mru != -1) {
            this.prev[var18] = this.mru;
            this.next[this.mru] = (short)var18;
         }

         this.mru = (short)var18;
         return (short)var19;
      }
   }
