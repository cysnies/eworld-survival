...
public class ClassFileCompiler extends Compiler implements CGConst {
   ...
   private static final Double POINT_5_D = new Double((double)0.5F);
   ...
   public ClassFileCompiler(String var1, String var2, OutputStream var3) throws IOException {
      this((Seekable)(new Seekable.File(var1)), var2, (OutputStream)var3);
   }

   public ClassFileCompiler(Seekable var1, String var2, OutputStream var3) throws IOException {
      this(var1, var2);
      if (var3 == null) {
   ...
   public ClassFileCompiler(Seekable var1, String var2, File var3) throws IOException {
      this(var1, var2);
      if (var3 == null) {
         throw new NullPointerException();
      } else {
   ...
   private ClassFileCompiler(Seekable var1, String var2) throws IOException {
      super(var1, var2);
   ...
   private void __go() throws Compiler.Exn, IOException {
      if (!this.pruneCases) {
         ...
         Type.Class var1 = Class.instance(this.runtimeClass);
         ...
         for(int var19 = 0; var19 < 32; ++var19) {
            this.cg.addField("f" + var19, this.singleFloat ? Type.FLOAT : Type.INT, 2);
         }
         ...
         for(int var3 = 0; var3 < this.elf.sheaders.length; ++var3) {
            ...
            if (var4.addr != 0) {
               var20 = Math.max(var20, var4.addr + var4.size);
               if (var5.equals(".text")) {
         ...
         this.init.add((byte)-79);
         if (this.supportCall) {
            Type.Class var21 = Class.instance(this.hashClass);
            this.clinit.add((byte)-69, var21);
            this.clinit.add((byte)89);
            this.clinit.add((byte)89);
            this.clinit.add((byte)-73, var21.method("<init>", Type.VOID, Type.NO_ARGS));
            this.clinit.add((byte)-77, this.me.field("symbols", var21));
            ELF.Symbol[] var23 = this.elf.getSymtab().symbols;

            for(int var25 = 0; var25 < var23.length; ++var25) {
               ELF.Symbol var6 = var23[var25];
               if (var6.type == 2 && var6.binding == 1 && (var6.name.equals("_call_helper") || !var6.name.startsWith("_"))) {
                  ...
                  this.clinit.add((byte)-74, var21.method("put", Type.OBJECT, new Type[]{Type.OBJECT, Type.OBJECT}));
         ...
         ELF.SHeader var22 = this.elf.sectionWithName(".text");
         MethodGen var24 = this.cg.addMethod("trampoline", Type.VOID, Type.NO_ARGS, 2);
         int var26 = var24.size();
         var24.add((byte)42);
         var24.add((byte)-76, this.me.field("state", Type.INT));
         var24.add((byte)-103, var24.size() + 2);
         var24.add((byte)-79);
         var24.add((byte)42);
         var24.add((byte)42);
         var24.add((byte)-76, this.me.field("pc", Type.INT));
         var24.add((byte)18, this.methodShift);
         var24.add((byte)124);
         int var27 = var22.addr >>> this.methodShift;
         int var7 = var22.addr + var22.size + this.maxBytesPerMethod - 1 >>> this.methodShift;
         MethodGen.Switch.Table var8 = new MethodGen.Switch.Table(var27, var7 - 1);
         var24.add((byte)-86, var8);

         for(int var9 = var27; var9 < var7; ++var9) {
            var8.setTargetForVal(var9, var24.size());
            var24.add((byte)-73, this.me.method("run_" + toHex(var9 << this.methodShift), Type.VOID, Type.NO_ARGS));
            var24.add((byte)-89, var26);
         }

         var8.setDefaultTarget(var24.size());
         var24.add((byte)87);
         var24.add((byte)-69, Class.instance("org.ibex.nestedvm.Runtime$ExecutionException"));
         var24.add((byte)89);
         var24.add((byte)-69, Type.STRINGBUFFER);
         var24.add((byte)89);
         var24.add((byte)18, "Jumped to invalid address in trampoline (r2: ");
         var24.add((byte)-73, Type.STRINGBUFFER.method("<init>", Type.VOID, new Type[]{Type.STRING}));
         var24.add((byte)42);
         var24.add((byte)-76, this.me.field("r2", Type.INT));
         var24.add((byte)-74, Type.STRINGBUFFER.method("append", Type.STRINGBUFFER, new Type[]{Type.INT}));
         var24.add((byte)18, " pc: ");
         var24.add((byte)-74, Type.STRINGBUFFER.method("append", Type.STRINGBUFFER, new Type[]{Type.STRING}));
         var24.add((byte)42);
         var24.add((byte)-76, this.me.field("pc", Type.INT));
         var24.add((byte)-74, Type.STRINGBUFFER.method("append", Type.STRINGBUFFER, new Type[]{Type.INT}));
         var24.add((byte)18, ")");
         var24.add((byte)-74, Type.STRINGBUFFER.method("append", Type.STRINGBUFFER, new Type[]{Type.STRING}));
         var24.add((byte)-74, Type.STRINGBUFFER.method("toString", Type.STRING, Type.NO_ARGS));
         var24.add((byte)-73, Class.instance("org.ibex.nestedvm.Runtime$ExecutionException").method("<init>", Type.VOID, new Type[]{Type.STRING}));
         var24.add((byte)-65);
         this.addConstReturnMethod("gp", this.gp.addr);
         this.addConstReturnMethod("entryPoint", this.elf.header.entry);
         this.addConstReturnMethod("heapStart", var20);
         ...
         if (this.supportCall) {
            Type.Class var28 = Class.instance(this.hashClass);
            MethodGen var10 = this.cg.addMethod("lookupSymbol", Type.INT, new Type[]{Type.STRING}, 4);
            var10.add((byte)-78, this.me.field("symbols", var28));
            var10.add((byte)43);
            var10.add((byte)-74, var28.method("get", Type.OBJECT, new Type[]{Type.OBJECT}));
            var10.add((byte)89);
         ...
         Type.Class var29 = Class.instance("org.ibex.nestedvm.Runtime$CPUState");
         MethodGen var30 = this.cg.addMethod("setCPUState", Type.VOID, new Type[]{var29}, 4);
         MethodGen var31 = this.cg.addMethod("getCPUState", Type.VOID, new Type[]{var29}, 4);
         var30.add((byte)43);
         var31.add((byte)43);
         var30.add((byte)-76, var29.field("r", Type.INT.makeArray()));
         var31.add((byte)-76, var29.field("r", Type.INT.makeArray()));
         var30.add((byte)77);
         var31.add((byte)77);

         for(int var12 = 1; var12 < 32; ++var12) {
            var30.add((byte)42);
            var30.add((byte)44);
            var30.add((byte)18, var12);
            var30.add((byte)46);
            var30.add((byte)-75, this.me.field("r" + var12, Type.INT));
            var31.add((byte)44);
            var31.add((byte)18, var12);
            var31.add((byte)42);
            var31.add((byte)-76, this.me.field("r" + var12, Type.INT));
            var31.add((byte)79);
         }

         var30.add((byte)43);
         var31.add((byte)43);
         var30.add((byte)-76, var29.field("f", Type.INT.makeArray()));
         var31.add((byte)-76, var29.field("f", Type.INT.makeArray()));
         var30.add((byte)77);
         var31.add((byte)77);
         ...
         for(int var32 = 0; var32 < 32; ++var32) {
            var30.add((byte)42);
            var30.add((byte)44);
            var30.add((byte)18, var32);
            var30.add((byte)46);
            if (this.singleFloat) {
               var30.add((byte)-72, Type.FLOAT_OBJECT.method("intBitsToFloat", Type.FLOAT, new Type[]{Type.INT}));
            }

            var30.add((byte)-75, this.me.field("f" + var32, this.singleFloat ? Type.FLOAT : Type.INT));
            var31.add((byte)44);
            var31.add((byte)18, var32);
            var31.add((byte)42);
            var31.add((byte)-76, this.me.field("f" + var32, this.singleFloat ? Type.FLOAT : Type.INT));
            if (this.singleFloat) {
               var31.add((byte)-72, Type.FLOAT_OBJECT.method("floatToIntBits", Type.INT, new Type[]{Type.FLOAT}));
            }

            var31.add((byte)79);
         }

         String[] var33 = new String[]{"hi", "lo", "fcsr", "pc"};

         for(int var13 = 0; var13 < var33.length; ++var13) {
            var30.add((byte)42);
            var30.add((byte)43);
            var30.add((byte)-76, var29.field(var33[var13], Type.INT));
            var30.add((byte)-75, this.me.field(var33[var13], Type.INT));
            var31.add((byte)43);
            var31.add((byte)42);
            var31.add((byte)-76, this.me.field(var33[var13], Type.INT));
            var31.add((byte)-75, var29.field(var33[var13], Type.INT));
         }

         var30.add((byte)-79);
         var31.add((byte)-79);
         MethodGen var34 = this.cg.addMethod("_execute", Type.VOID, Type.NO_ARGS, 4);
         int var14 = var34.size();
         var34.add((byte)42);
         var34.add((byte)-73, this.me.method("trampoline", Type.VOID, Type.NO_ARGS));
         int var15 = var34.size();
         var34.add((byte)-79);
         int var16 = var34.size();
         var34.add((byte)76);
         var34.add((byte)-69, Class.instance("org.ibex.nestedvm.Runtime$FaultException"));
         var34.add((byte)89);
         var34.add((byte)43);
         var34.add((byte)-73, Class.instance("org.ibex.nestedvm.Runtime$FaultException").method("<init>", Type.VOID, new Type[]{Class.instance("java.lang.RuntimeException")}));
         var34.add((byte)-65);
         var34.addExceptionHandler(var14, var15, var16, Class.instance("java.lang.RuntimeException"));
         var34.addThrow(Class.instance("org.ibex.nestedvm.Runtime$ExecutionException"));
         ...
         var17.add((byte)42);
         if (this.unixRuntime) {
            Type.Class var18 = Class.instance("org.ibex.nestedvm.UnixRuntime");
   ...
   private void emitData(int var1, DataInputStream var2, int var3, boolean var4) throws Compiler.Exn, IOException {
         ...
         for(int var5 = var1 + var3; var1 < var5; var3 -= var6) {
            ...
            for(int var8 = 0; var8 < var6; var8 += 7) {
               ...
               for(int var15 = 0; var15 < 8; ++var15) {
                  var7.append((char)((int)(var9 >>> 7 * (7 - var15) & 127L)));
               }
            }
   ...
   private void emitBSS(int var1, int var2) throws Compiler.Exn {
      if ((var1 & 3) != 0) {
   ...
   private void emitText(int var1, DataInputStream var2, int var3) throws Compiler.Exn, IOException {
      if (this.textDone) {
   ...
   private void startMethod(int var1) {
      ...
      for(int var5 = var1; var5 < this.endOfMethod; var5 += 4) {
         if (this.jumpable(var5)) {
            var3[var4] = this.insnTargets[(var5 - this.startOfMethod) / 4] = new MethodGen.PhantomTarget();
            var2[var4] = var5;
            ++var4;
         }
      }

      MethodGen.Switch.Lookup var6 = new MethodGen.Switch.Lookup(var4);
      System.arraycopy(var2, 0, var6.vals, 0, var4);
      System.arraycopy(var3, 0, var6.targets, 0, var4);
      var6.setDefaultTarget(this.defaultTarget = new MethodGen.PhantomTarget());
      this.fixupRegsStart();
      this.mg.add((byte)42);
   ...
   private int doIfInstruction(byte var1, int var2, int var3, int var4) throws Compiler.Exn {
      ...
      if ((var3 & this.methodMask) == (var2 & this.methodMask)) {
         ...
         int var5 = this.mg.add(MethodGen.negate(var1));
      ...
      if (!this.jumpable(var2 + 4)) {
         ...
         int var6 = this.mg.add((byte)-89);
         this.insnTargets[(var2 + 4 - this.startOfMethod) / 4].setTarget(this.mg.size());
         this.emitInstruction(-1, var4, 1);
         this.mg.setArg(var6, this.mg.size());
         return 2;
      }
   }

   private int emitInstruction(int var1, int var2, int var3) throws Compiler.Exn {
      ...
      if (var2 == -1) {
         ...
         switch (var6) {
            case 0:
               switch (var14) {
                  ...
                  case 12:
                     ...
                     int var33 = var4.add((byte)-103);
                     this.preSetPC();
                     var4.add((byte)18, var1 + 4);
                     this.setPC();
                     this.leaveMethod();
                     var4.setArg(var33, var4.size());
                     return var5;
                  case 13:
                  ...
                  case 42:
                     ...
                     if (var7 != var8) {
                        this.pushRegZ(0 + var7);
                        this.pushRegZ(0 + var8);
                        int var31 = var4.add((byte)-95);
                        var4.add((byte)3);
                        int var36 = var4.add((byte)-89);
                        var4.setArg(var31, var4.add((byte)4));
                        var4.setArg(var36, var4.size());
                     } else {
                        var4.add((byte)18, 0);
                     }
                  ...
                  case 43:
                     ...
                     if (var7 != var8) {
                        ...
                        if (var7 != 0) {
                           ...
                           var4.add((byte)127);
                           var4.add((byte)-108);
                           var30 = var4.add((byte)-101);
                        } else {
                           this.pushReg(0 + var8);
                           var30 = var4.add((byte)-102);
                        }

                        var4.add((byte)3);
                        int var35 = var4.add((byte)-89);
                        var4.setArg(var30, var4.add((byte)4));
                        var4.setArg(var35, var4.size());
                     } else {
                        var4.add((byte)18, 0);
                     }
            ...
            case 1:
               switch (var8) {
                  ...
                  case 16:
                     ...
                     this.pushRegWZ(0 + var7);
                     int var29 = var4.add((byte)-100);
                     this.emitInstruction(-1, var3, -1);
                     this.link(var1);
                     this.branch(var1, var1 + var18 * 4 + 4);
                     var4.setArg(var29, var4.size());
                     return var5;
                  case 17:
                     if (var1 == -1) {
                        throw new Compiler.Exn("pc modifying insn in delay slot");
            ...
            case 3:
               ...
               int var37 = var1 & -268435456 | var16 << 2;
               this.emitInstruction(-1, var3, -1);
               this.link(var1);
               this.branch(var1, var37);
               var5 |= 1;
               break;
            case 4:
               if (var1 == -1) {
            ...
            case 9:
               if (var7 != 0 && var18 != 0 && var7 == var8 && this.doLocal(var8) && var18 >= -32768 && var18 <= 32767) {
                  ...
                  var4.add((byte)-124, new MethodGen.Pair(this.getLocalForReg(var8), var18));
               } else {
            ...
            case 10:
               ...
               int var27 = var4.add((byte)-95);
               var4.add((byte)3);
               int var34 = var4.add((byte)-89);
               var4.setArg(var27, var4.add((byte)4));
               var4.setArg(var34, var4.size());
               this.setReg();
               break;
            case 11:
               this.preSetReg(0 + var8);
               ...
               var4.add((byte)-108);
               int var26 = var4.add((byte)-101);
               var4.add((byte)3);
               int var21 = var4.add((byte)-89);
               var4.setArg(var26, var4.add((byte)4));
                  ...
                  case 17:
                     ...
                     switch (var14) {
                        ...
                        case 33:
                           ...
                           return var5;
                        case 36:
                           MethodGen.Switch.Table var23 = new MethodGen.Switch.Table(0, 3);
                           this.preSetReg(32 + var13);
                           this.pushDouble(32 + var11, var22);
                           this.pushReg(66);
                           var4.add((byte)6);
   ...
   private int pushFloat(int var1) throws Compiler.Exn {
      return this.pushDouble(var1, false);
   }

   private int pushDouble(int var1, boolean var2) throws Compiler.Exn {
      if (var1 >= 32 && var1 < 64) {
   ...
   private int setDouble(boolean var1) throws Compiler.Exn {
