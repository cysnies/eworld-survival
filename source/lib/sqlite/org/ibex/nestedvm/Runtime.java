...
public abstract class Runtime implements UsermodeConstants, Registers, Cloneable {
   ...
   public void setCallJavaCB(CallJavaCB var1) {
   ...
   protected Object clone() throws CloneNotSupportedException {
      ...
      int var4 = this.writePages.length;
      var1.readPages = new int[var4][];
      var1.writePages = new int[var4][];
      ...
      for(int var3 = 0; var3 < var4; ++var3) {
         if (this.readPages[var3] != null) {
            if (this.writePages[var3] == null) {
               ...
               var1.readPages[var3] = var1.writePages[var3] = (int[])this.writePages[var3].clone();
            }
         }
      }
   ...
   protected Runtime(int var1, int var2, boolean var3) {
      ...
      if (var1 <= 0) {
         ...
         int var8 = 0;
         if (var2 > 1) {
            int var11 = max(var7, var1);
            var7 = var11 + var1 - 1 & ~(var1 - 1);
            var8 = var7 >>> this.pageShift;
            var5 = var5 + var1 - 1 & ~(var1 - 1);
            if (var8 + 4 + (var5 >>> this.pageShift) >= var2) {
         ...
         if (!var3) {
            ...
            Object var13 = win32Hacks ? new Win32ConsoleIS(System.in) : System.in;
            this.addFD(new TerminalFD((InputStream)var13));
   ...
   public final void copyin(int var1, byte[] var2, int var3) throws ReadFaultException {
      int var4 = 1 << this.pageShift >>> 2;
      int var5 = var4 - 1;
      int var6 = 0;
      if (var3 != 0) {
         if ((var1 & 3) != 0) {
            int var7 = this.memRead(var1 & -4);
            switch (var1 & 3) {
               case 1:
         ...
         if ((var3 & -4) != 0) {
            ...
            int var8;
            int var11;
            for(var8 = var1 >>> 2; var14 != 0; var14 -= var11) {
               int[] var9 = this.readPages[var8 >>> this.pageShift - 2];
               if (var9 == null) {
                  throw new ReadFaultException(var8 << 2);
               }

               int var10 = var8 & var5;
               var11 = min(var14, var4 - var10);
         ...
         if (var3 != 0) {
            int var15 = this.memRead(var1);
            switch (var3) {
               case 3:
                  var2[var6 + 2] = (byte)(var15 >>> 8 & 255);
               case 2:
                  var2[var6 + 1] = (byte)(var15 >>> 16 & 255);
               case 1:
                  var2[var6 + 0] = (byte)(var15 >>> 24 & 255);
            }
         }
   ...
   public final void copyout(byte[] var1, int var2, int var3) throws FaultException {
      int var4 = 1 << this.pageShift >>> 2;
      int var5 = var4 - 1;
      int var6 = 0;
      if (var3 != 0) {
         if ((var2 & 3) != 0) {
            int var7 = this.memRead(var2 & -4);
            switch (var2 & 3) {
               case 1:
         ...
         if ((var3 & -4) != 0) {
            ...
            int var8;
            int var11;
            for(var8 = var2 >>> 2; var13 != 0; var13 -= var11) {
               int[] var9 = this.writePages[var8 >>> this.pageShift - 2];
               if (var9 == null) {
                  throw new WriteFaultException(var8 << 2);
               }

               int var10 = var8 & var5;
               var11 = min(var13, var4 - var10);
         ...
         if (var3 != 0) {
            int var14 = this.memRead(var2);
            switch (var3) {
               case 1:
                  var14 = var14 & 16777215 | (var1[var6 + 0] & 255) << 24;
                  break;
               case 2:
                  var14 = var14 & '\uffff' | (var1[var6 + 0] & 255) << 24 | (var1[var6 + 1] & 255) << 16;
                  break;
               case 3:
                  var14 = var14 & 255 | (var1[var6 + 0] & 255) << 24 | (var1[var6 + 1] & 255) << 16 | (var1[var6 + 2] & 255) << 8;
            }

            this.memWrite(var2, var14);
         }

      }
   }

   public final void memcpy(int var1, int var2, int var3) throws FaultException {
      int var4 = 1 << this.pageShift >>> 2;
      int var5 = var4 - 1;
      if ((var1 & 3) == 0 && (var2 & 3) == 0) {
         if ((var3 & -4) != 0) {
            ...
            int var8;
            int var13;
            for(var8 = var1 >>> 2; var14 != 0; var14 -= var13) {
               int[] var9 = this.readPages[var16 >>> this.pageShift - 2];
               if (var9 == null) {
                  throw new ReadFaultException(var16 << 2);
               }
               ...
               int var11 = var16 & var5;
               int var12 = var8 & var5;
               var13 = min(var14, var4 - max(var11, var12));
         ...
         if (var3 != 0) {
            int var15 = this.memRead(var2);
            int var17 = this.memRead(var1);
            switch (var3) {
               case 1:
                  this.memWrite(var1, var15 & -16777216 | var17 & 16777215);
                  break;
               case 2:
                  this.memWrite(var1, var15 & -65536 | var17 & '\uffff');
                  break;
               case 3:
                  this.memWrite(var1, var15 & -256 | var17 & 255);
            }
         }
      } else {
         while(var3 > 0) {
            int var6 = min(var3, 16776192);
   ...
   public final void memset(int var1, int var2, int var3) throws FaultException {
      int var4 = 1 << this.pageShift >>> 2;
      int var5 = var4 - 1;
      ...
      if ((var3 & -4) != 0) {
         ...
         int var8;
         int var11;
         for(var8 = var1 >>> 2; var13 != 0; var13 -= var11) {
            int[] var9 = this.readPages[var8 >>> this.pageShift - 2];
            if (var9 == null) {
               throw new WriteFaultException(var8 << 2);
            }
      ...
      if (var3 != 0) {
         int var14 = this.memRead(var1);
         switch (var3) {
            case 1:
               var14 = var14 & 16777215 | var6 & -16777216;
               break;
            case 2:
               var14 = var14 & '\uffff' | var6 & -65536;
               break;
            case 3:
               var14 = var14 & 255 | var6 & -256;
         }

         this.memWrite(var1, var14);
      }

   }

   public final int memRead(int var1) throws ReadFaultException {
      if ((var1 & 3) != 0) {
         throw new ReadFaultException(var1);
      } else {
         return this.unsafeMemRead(var1);
      }
   }

   protected final int unsafeMemRead(int var1) throws ReadFaultException {
   ...
   public final void memWrite(int var1, int var2) throws WriteFaultException {
      if ((var1 & 3) != 0) {
         throw new WriteFaultException(var1);
      } else {
         this.unsafeMemWrite(var1, var2);
      }
   }

   protected final void unsafeMemWrite(int var1, int var2) throws WriteFaultException {
   ...
   private int addStringArray(String[] var1, int var2) throws FaultException {
      ...
      var4 += (var3 + 1) * 4;
      int var12 = var2 - var4 & -4;
      int var6 = var12 + (var3 + 1) * 4;
      ...
      try {
         ...
         for(int var14 = 0; var14 < var3 + 1; ++var14) {
            this.memWrite(var6, var7[var14]);
            var6 += 4;
         }

         return var12;
      } catch (FaultException var10) {
   ...
   public final void start(String[] var1, String[] var2) {
      if (this.state != 1) {
         ...
         if (var3 - var4 > 65536) {
            ...
            CPUState var12 = new CPUState();
            var12.r[4] = var5;
            var12.r[5] = var6;
            var12.r[29] = var4;
            var12.r[31] = -559038737;
            var12.r[28] = this.gp();
            var12.pc = this.entryPoint();
            this.setCPUState(var12);
            this.state = 2;
            this._started();
         }
      }
   ...
   public final int call(String var1, Object[] var2) throws CallException, FaultException {
   ...
   public final int call(String var1) throws CallException {
      return this.call(var1, new int[0]);
   }

   public final int call(String var1, int var2) throws CallException {
      return this.call(var1, new int[]{var2});
   }

   public final int call(String var1, int var2, int var3) throws CallException {
   ...
   public final int call(String var1, int[] var2) throws CallException {
      ...
      if (var3 == -1) {
         throw new CallException(var1 + " not found");
      } else {
   ...
   public final int call(int var1, int var2, int[] var3) throws CallException {
      if (var3.length > 7) {
         ...
         int var4 = this.state;
         CPUState var5 = new CPUState();
         this.getCPUState(var5);
         CPUState var6 = var5.dup();
         var6.r[29] &= -16;
         var6.r[31] = -559038737;
         var6.r[4] = var2;
         switch (var3.length) {
   ...
   public final int addFD(FD var1) {
   ...
   void _preCloseFD(FD var1) {
   }

   void _postCloseFD(FD var1) {
   }
   ...
   FD hostFSOpen(final File var1, int var2, int var3, final Object var4) throws ErrnoException {
      if ((var2 & -3596) != 0) {
         ...
         return new SeekableFD(var6, var2) {
            protected FStat _fstat() {
               return Runtime.this.hostFStat(var1, var6, var4);
            }
         };
      }
   }

   FStat hostFStat(File var1, Seekable.File var2, Object var3) {
      return new HostFStat(var1, var2);
   }

   FD hostFSDirFD(File var1, Object var2) {
      return null;
   }

   FD _open(String var1, int var2, int var3) throws ErrnoException {
      return this.hostFSOpen(new File(var1), var2, var3, (Object)null);
   }

   private int sys_open(int var1, int var2, int var3) throws ErrnoException, FaultException {
      ...
      var2 &= -32769;
      FD var5 = this._open(var4, var2, var3);
      if (var5 == null) {
         return -2;
      } else {
   ...
   private int sys_write(int var1, int var2, int var3) throws FaultException, ErrnoException {
   ...
   private int sys_read(int var1, int var2, int var3) throws FaultException, ErrnoException {
      var3 = Math.min(var3, 16776192);
      if (var1 >= 0 && var1 < 64) {
         if (this.fds[var1] == null) {
            return -81;
   ...
   private int sys_lseek(int var1, int var2, int var3) throws ErrnoException {
      if (var1 >= 0 && var1 < 64) {
         if (this.fds[var1] == null) {
            return -81;
   ...
   int stat(FStat var1, int var2) throws FaultException {
   ...
   private int sys_fstat(int var1, int var2) throws FaultException {
      if (var1 >= 0 && var1 < 64) {
         return this.fds[var1] == null ? -81 : this.stat(this.fds[var1].fstat(), var2);
      } else {
         return -81;
      }
   }

   private int sys_gettimeofday(int var1, int var2) throws FaultException {
   ...
   final int sys_fcntl(int var1, int var2, int var3) throws FaultException {
      if (var1 >= 0 && var1 < 64) {
         if (this.fds[var1] == null) {
            return -81;
         } else {
            FD var5 = this.fds[var1];
            switch (var2) {
               case 0:
                  if (var3 >= 0 && var3 < 64) {
                     int var4;
   ...
   int _syscall(int var1, int var2, int var3, int var4, int var5, int var6, int var7) throws ErrnoException, FaultException {
      switch (var1) {
         case 0:
            return 0;
         case 1:
   ...
   public final String utfstring(int var1) throws ReadFaultException {
      if (var1 == 0) {
         return null;
      } else {
         int var2 = var1;
   ...
   public final String cstring(int var1) throws ReadFaultException {
      if (var1 == 0) {
         return null;
      } else {
   ...
   protected final void nullPointerCheck(int var1) throws ExecutionException {
      if (var1 < 65536) {
         throw new ExecutionException("Attempted to dereference a null pointer " + toHex(var1));
      }
   }
   ...
   static {
      ...
      if (var1 != null) {
         win32Hacks = Boolean.valueOf(var1);
      } else {
   ...
   public abstract static class FD {
      ...
      public int read(byte[] var1, int var2, int var3) throws ErrnoException {
         throw new ErrnoException(81);
      }

      public int write(byte[] var1, int var2, int var3) throws ErrnoException {
         throw new ErrnoException(81);
      }

      public int seek(int var1, int var2) throws ErrnoException {
         return -1;
      }

      public int getdents(byte[] var1, int var2, int var3) throws ErrnoException {
         throw new ErrnoException(81);
      }
   ...
   public abstract static class SeekableFD extends FD {
      ...
      SeekableFD(Seekable var1, int var2) {
         super();
         this.data = var1;
         this.flags = var2;
      }
   ...
   public static class InputOutputStreamFD extends FD {
      ...
      public InputOutputStreamFD(InputStream var1) {
         this(var1, (OutputStream)null);
      }

      public InputOutputStreamFD(OutputStream var1) {
         this((InputStream)null, var1);
      }

      public InputOutputStreamFD(InputStream var1, OutputStream var2) {
         super();
         this.is = var1;
         this.os = var2;
   ...
   static class TerminalFD extends InputOutputStreamFD {
      public TerminalFD(InputStream var1) {
         this(var1, (OutputStream)null);
      }

      public TerminalFD(OutputStream var1) {
         this((InputStream)null, var1);
      }

      public TerminalFD(InputStream var1, OutputStream var2) {
         super(var1, var2);
      }
   ...
   static class Win32ConsoleIS extends InputStream {
      ...
      public Win32ConsoleIS(InputStream var1) {
         super();
         this.parent = var1;
      }
      ...
      public int read() throws IOException {
         if (this.pushedBack != -1) {
            int var2 = this.pushedBack;
            this.pushedBack = -1;
            return var2;
         } else {
            int var1 = this.parent.read();
   ...
   static class HostFStat extends FStat {
      ...
      public HostFStat(File var1, Seekable.File var2) {
         this(var1, var2, false);
      }

      public HostFStat(File var1, boolean var2) {
         this(var1, (Seekable.File)null, var2);
      }

      public HostFStat(File var1, Seekable.File var2, boolean var3) {
         super();
         this.f = var1;
         this.sf = var2;
   ...
   public static class ReadFaultException extends FaultException {
      public ReadFaultException(int var1) {
         super(var1);
      }
   }

   public static class WriteFaultException extends FaultException {
      public WriteFaultException(int var1) {
         super(var1);
      }
   }
   ...
   public static class FaultException extends ExecutionException {
      ...
      public FaultException(int var1) {
         super("fault at: " + Runtime.toHex(var1));
         this.addr = var1;
         this.cause = null;
      }

      public FaultException(RuntimeException var1) {
         super(var1.toString());
         this.addr = -1;
         this.cause = var1;
      }
   ...
   public static class ExecutionException extends Exception {
      ...
      public ExecutionException(String var1) {
         super();
         if (var1 != null) {
            this.message = var1;
         }
   ...
   public static class CallException extends Exception {
      public CallException(String var1) {
         super(var1);
      }
   }
   ...
   protected static class ErrnoException extends Exception {
      ...
      public ErrnoException(int var1) {
         super("Errno: " + var1);
         this.errno = var1;
      }
   }
