...
public abstract class Compiler implements Registers {
   ...
   public Compiler(Seekable var1, String var2) throws IOException {
      super();
               ...
               if (this.gp == null) {
                  ...
                  for(int var7 = 0; var7 < this.elf.sheaders.length; ++var7) {
                     ...
                     if ((this.elf.sheaders[var7].flags & 2) != 0 && !var8.equals(".text") && !var8.equals(".data") && !var8.equals(".sdata") && !var8.equals(".rodata") && !var8.equals(".ctors") && !var8.equals(".dtors") && !var8.equals(".bss") && !var8.equals(".sbss")) {
                        throw new Exn("Unknown section: " + var8);
                     }
                  }
   ...
   private void findBranchesInText(int var1, DataInputStream var2, int var3, Hashtable var4) throws IOException {
      int var5 = var3 / 4;
      int var6 = var1;
      int var7 = 0;
      int[] var8 = new int[32];
   ...
   private void findBranchesInData(DataInputStream var1, int var2, Hashtable var3, int var4, int var5) throws IOException {
      int var6 = var2 / 4;
      int var7 = 0;
   ...
   public void parseOptions(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         while(var2.hasMoreElements()) {
            ...
            Option var6 = this.getOption(var4);
            if (var6 == null) {
   ...
   private static String wrapAndIndent(String var0, int var1, int var2, int var3) {
      ...
      String var7;
      for(int var9 = 0; var4.hasMoreTokens(); var9 += var7.length()) {
         var7 = var4.nextToken();
         if (var7.length() + var9 + 1 > var3 && var9 > 0) {
            var5.append('\n');
   ...
   private class Option {
      ...
      public Option(String var2) throws NoSuchFieldException {
         super();
      ...
      public void set(Object var1) {
         if (this.field != null) {
            try {
               this.field.set(Compiler.this, var1);
