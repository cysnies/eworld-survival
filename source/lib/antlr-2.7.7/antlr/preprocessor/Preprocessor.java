...
public class Preprocessor extends LLkParser implements PreprocessorTokenTypes {
   ...
   public final void grammarFile(Hierarchy var1, String var2) throws RecognitionException, TokenStreamException {
      ...
      try {
         while(this.LA(1) == 5) {
            ...
            this.match(5);
            var1.getFile(var2).addHeaderAction(var8.getText());
         }
                           ...
                           case 18:
                              ...
                              switch (this.LA(1)) {
                                 ...
                                 case 12:
                                    ...
                                    this.match(12);
                                    var3.setTokenSection(var18.getText());
                                 case 7:
                                 case 9:
                                 case 16:
                                 case 17:
                                 case 18:
                                    switch (this.LA(1)) {
                                       case 7:
                                          ...
                                          this.match(7);
                                          var3.setMemberAction(var19.getText());
                                       case 9:
                                       case 16:
                                       case 17:
                                       case 18:
                                    ...
                                    case 22:
                                       switch (this.LA(1)) {
                                          ...
                                          case 22:
                                             var6 = this.LT(1);
                                             this.match(22);
                                             String var17 = this.exceptionGroup();
                                             String var12 = var6.getText() + var17;
   ...
   public final String throwsSpec() throws RecognitionException, TokenStreamException {
      ...
      try {
         ...
         for(var1 = var1 + var6.getText(); this.LA(1) == 24; var1 = var1 + "," + var7.getText()) {
            this.match(24);
            var7 = this.LT(1);
            this.match(9);
         }
   ...
   public final String exceptionGroup() throws RecognitionException, TokenStreamException {
      ...
      try {
         while(this.LA(1) == 25) {
            String var5 = this.exceptionSpec();
            var1 = var1 + var5;
         }
   ...
   public final String exceptionSpec() throws RecognitionException, TokenStreamException {
      ...
      try {
         ...
         while(this.LA(1) == 26) {
            String var7 = this.exceptionHandler();
            var1 = var1 + var7;
         }
      } catch (RecognitionException var5) {
         this.reportError(var5);
