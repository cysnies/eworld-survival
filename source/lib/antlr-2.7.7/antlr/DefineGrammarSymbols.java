...
public class DefineGrammarSymbols implements ANTLRGrammarParseBehavior {
   ...
   public void defineToken(Token var1, Token var2) {
      ...
      if (var4 != null) {
         ...
         if (var3 != null) {
            TokenSymbol var6 = this.grammar.tokenManager.getTokenSymbol(var3);
            if (var6 != null) {
         ...
         var5 = new StringLiteralSymbol(var4);
         int var11 = this.grammar.tokenManager.nextTokenType();
         var5.setTokenType(var11);
         var5.setLabel(var3);
         this.grammar.tokenManager.define(var5);
         if (var3 != null) {
            this.grammar.tokenManager.mapToTokenSymbol(var3, var5);
         ...
         int var10 = this.grammar.tokenManager.nextTokenType();
         TokenSymbol var12 = new TokenSymbol(var3);
         var12.setTokenType(var10);
         this.grammar.tokenManager.define(var12);
      }
   ...
   public void endOptions() {
      if (this.grammar.exportVocab == null && this.grammar.importVocab == null) {
         ...
         if (this.tokenManagers.containsKey("*default")) {
            ...
            TokenManager var9 = (TokenManager)this.tokenManagers.get("*default");
            this.grammar.setTokenManager(var9);
         } else {
            SimpleTokenManager var8 = new SimpleTokenManager(this.grammar.exportVocab, this.tool);
            this.grammar.setTokenManager(var8);
            this.tokenManagers.put(this.grammar.exportVocab, var8);
            this.tokenManagers.put("*default", var8);
         }
         ...
         if (this.grammar.importVocab.equals(this.grammar.exportVocab)) {
            ...
            TokenManager var7 = (TokenManager)this.tokenManagers.get(this.grammar.importVocab);
            TokenManager var10 = (TokenManager)var7.clone();
            var10.setName(this.grammar.exportVocab);
            var10.setReadOnly(false);
            this.grammar.setTokenManager(var10);
            this.tokenManagers.put(this.grammar.exportVocab, var10);
         } else {
            ImportVocabTokenManager var6 = new ImportVocabTokenManager(this.grammar, this.grammar.importVocab + CodeGenerator.TokenTypesFileSuffix + CodeGenerator.TokenTypesFileExt, this.grammar.exportVocab, this.tool);
            var6.setReadOnly(false);
            this.tokenManagers.put(this.grammar.exportVocab, var6);
            this.grammar.setTokenManager(var6);
            if (!this.tokenManagers.containsKey("*default")) {
               this.tokenManagers.put("*default", var6);
            }

         }
      } else if (this.grammar.exportVocab != null && this.grammar.importVocab == null) {
         if (this.tokenManagers.containsKey(this.grammar.exportVocab)) {
            TokenManager var5 = (TokenManager)this.tokenManagers.get(this.grammar.exportVocab);
            this.grammar.setTokenManager(var5);
         } else {
            SimpleTokenManager var4 = new SimpleTokenManager(this.grammar.exportVocab, this.tool);
         ...
         if (this.tokenManagers.containsKey(this.grammar.importVocab)) {
            TokenManager var3 = (TokenManager)this.tokenManagers.get(this.grammar.importVocab);
            TokenManager var2 = (TokenManager)var3.clone();
            ...
            ImportVocabTokenManager var1 = new ImportVocabTokenManager(this.grammar, this.grammar.importVocab + CodeGenerator.TokenTypesFileSuffix + CodeGenerator.TokenTypesFileExt, this.grammar.exportVocab, this.tool);
