...
public class CSharpCodeGenerator extends CodeGenerator {
   ...
   public void genBody(LexerGrammar var1) throws IOException {
      ...
      if (this.grammar.superClass != null) {
         var9 = this.grammar.superClass;
      } else {
         var9 = "antlr." + this.grammar.getSuperClass();
      }
      ...
      this.print("class " + this.grammar.getClassName() + " : " + var9);
      ...
      Enumeration var11 = this.grammar.tokenManager.getTokenSymbolKeys();

      while(var11.hasMoreElements()) {
         String var6 = (String)var11.nextElement();
         if (var6.charAt(0) == '"') {
      ...
      if (this.grammar.debuggingOutput) {
         ...
         Enumeration var12 = this.grammar.rules.elements();
         boolean var14 = false;

         while(var12.hasMoreElements()) {
            GrammarSymbol var16 = (GrammarSymbol)var12.nextElement();
            if (var16 instanceof RuleSymbol) {
               this.println("  \"" + ((RuleSymbol)var16).getId() + "\",");
            }
         }
      ...
      this.genNextToken();
      Enumeration var13 = this.grammar.rules.elements();

      for(int var15 = 0; var13.hasMoreElements(); this.exitIfError()) {
         RuleSymbol var17 = (RuleSymbol)var13.nextElement();
         if (!var17.getId().equals("mnextToken")) {
            this.genRule(var17, false, var15++, this.grammar.tokenManager);
         }
      }
   ...
   public void genBody(ParserGrammar var1) throws IOException {
      ...
      String var11;
      if (this.grammar.superClass != null) {
         var11 = this.grammar.superClass;
      } else {
         var11 = "antlr." + this.grammar.getSuperClass();
      }
      ...
      this.println("class " + this.grammar.getClassName() + " : " + var11);
      Token var12 = (Token)this.grammar.options.get("classHeaderSuffix");
      if (var12 != null) {
         String var7 = StringUtils.stripFrontBack(var12.getText(), "\"", "\"");
         if (var7 != null) {
            this.print("              , " + var7);
         }
      }
      ...
      if (this.grammar.debuggingOutput) {
         ...
         while(var13.hasMoreElements()) {
            GrammarSymbol var9 = (GrammarSymbol)var13.nextElement();
      ...
      Enumeration var14 = this.grammar.rules.elements();

      for(int var15 = 0; var14.hasMoreElements(); this.exitIfError()) {
         GrammarSymbol var16 = (GrammarSymbol)var14.nextElement();
         if (var16 instanceof RuleSymbol) {
            RuleSymbol var10 = (RuleSymbol)var16;
            this.genRule(var10, var10.references.size() == 0, var15++, this.grammar.tokenManager);
         }
      }
   ...
   public void genBody(TreeWalkerGrammar var1) throws IOException {
      ...
      String var10;
      if (this.grammar.superClass != null) {
         var10 = this.grammar.superClass;
      } else {
         var10 = "antlr." + this.grammar.getSuperClass();
      }
      ...
      this.println("class " + this.grammar.getClassName() + " : " + var10);
      Token var11 = (Token)this.grammar.options.get("classHeaderSuffix");
      if (var11 != null) {
         String var5 = StringUtils.stripFrontBack(var11.getText(), "\"", "\"");
         if (var5 != null) {
            this.print("              , " + var5);
         }
      }
      ...
      for(String var7 = ""; var12.hasMoreElements(); this.exitIfError()) {
         GrammarSymbol var8 = (GrammarSymbol)var12.nextElement();
   ...
   private void genElementAST(AlternativeElement var1) {
      if (this.grammar instanceof TreeWalkerGrammar && !this.grammar.buildAST) {
         ...
         if (this.grammar.buildAST && this.syntacticPredLevel == 0) {
            ...
            if (this.grammar instanceof TreeWalkerGrammar) {
               this.println(this.labeledElementASTType + " " + var10 + "_in = null;");
            }
               ...
               switch (var1.getAutoGenType()) {
                  case 1:
                     if (!this.usingCustomAST && (!(var1 instanceof GrammarAtom) || ((GrammarAtom)var1).getASTNodeType() == null)) {
                        this.println("astFactory.addASTChild(ref currentAST, " + var10 + ");");
                     } else {
                        this.println("astFactory.addASTChild(ref currentAST, (AST)" + var10 + ");");
                     }
                     break;
                  case 2:
                     if (!this.usingCustomAST && (!(var1 instanceof GrammarAtom) || ((GrammarAtom)var1).getASTNodeType() == null)) {
                        this.println("astFactory.makeASTRoot(ref currentAST, " + var10 + ");");
                     } else {
                        this.println("astFactory.makeASTRoot(ref currentAST, (AST)" + var10 + ");");
                     }
               }
            }
   ...
   public void genNextToken() {
      ...
      if (!var1) {
         ...
         RuleSymbol var11 = new RuleSymbol("mnextToken");
         var11.setDefined();
         var11.setBlock(var10);
         var11.access = "private";
         this.grammar.define(var11);
         ...
         for(int var12 = 0; var12 < var10.getAlternatives().size(); ++var12) {
            Alternative var7 = var10.getAlternativeAt(var12);
         ...
         CSharpBlockFinishingInfo var14 = this.genCommonBlock(var10, false);
         String var15 = "if (cached_LA1==EOF_CHAR) { uponEOF(); returnToken_ = makeToken(Token.EOF_TYPE); }";
         var15 = var15 + var13 + "\t\t\t\t";
         if (((LexerGrammar)this.grammar).filterMode) {
            if (var5 == null) {
               var15 = var15 + "\t\t\t\telse";
               var15 = var15 + "\t\t\t\t{";
               var15 = var15 + "\t\t\t\t\tconsume();";
               var15 = var15 + "\t\t\t\t\tgoto tryAgain;";
               var15 = var15 + "\t\t\t\t}";
            } else {
               var15 = var15 + "\t\t\t\t\telse" + var13 + "\t\t\t\t\t{" + var13 + "\t\t\t\t\tcommit();" + var13 + "\t\t\t\t\ttry {m" + var5 + "(false);}" + var13 + "\t\t\t\t\tcatch(RecognitionException e)" + var13 + "\t\t\t\t\t{" + var13 + "\t\t\t\t\t\t// catastrophic failure" + var13 + "\t\t\t\t\t\treportError(e);" + var13 + "\t\t\t\t\t\tconsume();" + var13 + "\t\t\t\t\t}" + var13 + "\t\t\t\t\tgoto tryAgain;" + var13 + "\t\t\t\t}";
            }
         } else {
            var15 = var15 + "else {" + this.throwNoViable + "}";
         }

         this.genBlockFinish(var14, var15);
      ...
      if (!var1.isDefined()) {
         ...
         if (var7 != null) {
            ...
            if (!(this.grammar instanceof TreeWalkerGrammar)) {
               ...
               String var12 = this.getBitsetName(this.markBitsetForGen(var10.fset));
               this.println("recover(ex," + var12 + ");");
            } else {
               this.println("if (null != _t)");
               this.println("{");
               ++this.tabs;
   ...
   public String getASTCreateString(String var1) {
      ...
      if (var5 != -1) {
         ...
         String var8 = var1.substring(var5 + 1, var1.length());
         var5 = var8.indexOf(44);
         if (var5 != -1) {
            var6 = true;
         }
      }
   ...
   private void setupGrammarParameters(Grammar var1) {
      ...
      if (var1 instanceof ParserGrammar) {
         ...
         if (var1.hasOption("ASTLabelType")) {
            Token var5 = var1.getOption("ASTLabelType");
            if (var5 != null) {
               String var6 = StringUtils.stripFrontBack(var5.getText(), "\"", "\"");
               if (var6 != null) {
                  this.usingCustomAST = true;
                  this.labeledElementASTType = var6;
                  this.labeledElementType = var6;
               }
            }
         }
