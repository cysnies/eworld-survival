...
public class CppCodeGenerator extends CodeGenerator {
      ...
      if (var1 instanceof RuleBlock) {
         ...
         if (var2.labeledElements != null) {
            for(int var3 = 0; var3 < var2.labeledElements.size(); ++var3) {
               ...
               } else if (!(var4 instanceof RuleRefElement) && ((AlternativeBlock)var4).not && this.analyzer.subruleCanBeInverted((AlternativeBlock)var4, this.grammar instanceof LexerGrammar)) {
                  this.println(this.labeledElementType + " " + var4.getLabel() + " = " + this.labeledElementInit + ";");
                  if (this.grammar.buildAST) {
                     this.genASTDeclaration(var4);
                  }
   ...
   public void genBody(LexerGrammar var1) throws IOException {
      ...
      if (this.grammar.superClass != null) {
         var7 = this.grammar.superClass;
      } else {
         var7 = this.grammar.getSuperClass();
         if (var7.lastIndexOf(46) != -1) {
            var7 = var7.substring(var7.lastIndexOf(46) + 1);
         }

         var7 = namespaceAntlr + var7;
      }
      ...
      ++this.tabs;
      if (this.grammar.debuggingOutput) {
         this.println(": " + var7 + "(new " + namespaceAntlr + "DebuggingInputBuffer(new " + namespaceAntlr + "CharBuffer(in))," + var1.caseSensitive + ")");
      } else {
         this.println(": " + var7 + "(new " + namespaceAntlr + "CharBuffer(in)," + var1.caseSensitive + ")");
      }
      ...
      ++this.tabs;
      if (this.grammar.debuggingOutput) {
         this.println(": " + var7 + "(new " + namespaceAntlr + "DebuggingInputBuffer(ib)," + var1.caseSensitive + ")");
      } else {
         this.println(": " + var7 + "(ib," + var1.caseSensitive + ")");
      }
      ...
      ++this.tabs;
      this.println(": " + var7 + "(state," + var1.caseSensitive + ")");
      --this.tabs;
      this.println("{");
      ++this.tabs;
      if (this.grammar.debuggingOutput) {
      ...
      if (this.grammar.debuggingOutput) {
         ...
         ++this.tabs;
         Enumeration var9 = this.grammar.rules.elements();
         boolean var11 = false;

         while(var9.hasMoreElements()) {
            GrammarSymbol var13 = (GrammarSymbol)var9.nextElement();
      ...
      for(int var12 = 0; var10.hasMoreElements(); this.exitIfError()) {
         ...
         if (!var14.getId().equals("mnextToken")) {
            this.genRule(var14, false, var12++, this.grammar.getClassName() + "::");
         }
      }
   ...
   public void genBody(ParserGrammar var1) throws IOException {
      ...
      if (this.grammar.debuggingOutput) {
         ...
         while(var3.hasMoreElements()) {
            GrammarSymbol var5 = (GrammarSymbol)var3.nextElement();
      ...
      for(int var10 = 0; var9.hasMoreElements(); this.exitIfError()) {
         GrammarSymbol var11 = (GrammarSymbol)var9.nextElement();
         if (var11 instanceof RuleSymbol) {
            RuleSymbol var6 = (RuleSymbol)var11;
            this.genRule(var6, var6.references.size() == 0, var10++, this.grammar.getClassName() + "::");
         }
      }
   ...
   public void genBody(TreeWalkerGrammar var1) throws IOException {
      ...
      Object var2 = null;
      if (this.grammar.superClass != null) {
         String var8 = this.grammar.superClass;
      } else {
         String var9 = this.grammar.getSuperClass();
         if (var9.lastIndexOf(46) != -1) {
            var9 = var9.substring(var9.lastIndexOf(46) + 1);
         }

         (new StringBuffer()).append(namespaceAntlr).append(var9).toString();
      }
   ...
   public CppBlockFinishingInfo genCommonBlock(AlternativeBlock var1, boolean var2) {
      ...
      if (var1.not && this.analyzer.subruleCanBeInverted(var1, this.grammar instanceof LexerGrammar)) {
         ...
         if (this.grammar instanceof TreeWalkerGrammar) {
            if (this.usingCustomAST) {
               var22 = namespaceAntlr + "RefAST" + "(_t),";
            } else {
               var22 = "_t,";
            }
         }

         this.println("match(" + var22 + this.getBitsetName(this.markBitsetForGen(var19.fset)) + ");");
         if (this.grammar instanceof TreeWalkerGrammar) {
            this.println("_t = _t->getNextSibling();");
         }
         ...
         for(int var10 = 0; var10 < var1.getAlternatives().size(); ++var10) {
         ...
         if (var18 >= this.makeSwitchThreshold) {
            String var20 = this.lookaheadString(1);
            var4 = true;
            if (this.grammar instanceof TreeWalkerGrammar) {
            ...
            for(int var23 = 0; var23 < var1.alternatives.size(); ++var23) {
               Alternative var12 = var1.getAlternativeAt(var23);
         ...
         int var21 = this.grammar instanceof LexerGrammar ? this.grammar.maxk : 0;

         for(int var24 = var21; var24 >= 0; --var24) {
            if (this.DEBUG_CODE_GENERATOR || this.DEBUG_CPP_CODE_GENERATOR) {
               System.out.println("checking depth " + var24);
            }

            for(int var26 = 0; var26 < var1.alternatives.size(); ++var26) {
               Alternative var28 = var1.getAlternativeAt(var26);
               if (this.DEBUG_CODE_GENERATOR || this.DEBUG_CPP_CODE_GENERATOR) {
                  System.out.println("genAlt: " + var26);
               }

               if (var4 && suitableForCaseExpression(var28)) {
                  if (this.DEBUG_CODE_GENERATOR || this.DEBUG_CPP_CODE_GENERATOR) {
                  ...
                  String var14;
                  if (this.grammar instanceof LexerGrammar) {
                     int var16 = var28.lookaheadDepth;
                     if (var16 == Integer.MAX_VALUE) {
                        var16 = this.grammar.maxk;
                     }

                     while(var16 >= 1 && var28.cache[var16].containsEpsilon()) {
                        --var16;
                     }

                     if (var16 != var24) {
                        if (this.DEBUG_CODE_GENERATOR || this.DEBUG_CPP_CODE_GENERATOR) {
                           System.out.println("ignoring alt because effectiveDepth!=altDepth;" + var16 + "!=" + var24);
                        }
                        continue;
                     }

                     var15 = this.lookaheadIsEmpty(var28, var16);
                     var14 = this.getLookaheadTestExpression(var28, var16);
                  } else {
                     var15 = this.lookaheadIsEmpty(var28, this.grammar.maxk);
                     var14 = this.getLookaheadTestExpression(var28, this.grammar.maxk);
                  }

                  if (var28.cache[1].fset.degree() > 127 && suitableForCaseExpression(var28)) {
                     if (var3 == 0) {
                        if (this.grammar instanceof TreeWalkerGrammar) {
                           this.println("if (_t == " + this.labeledElementASTInit + " )");
                           ++this.tabs;
                  ...
                  } else if (var15 && var28.semPred == null && var28.synPred == null) {
                     if (var3 == 0) {
                        this.println("{");
                     } else {
                        this.println("else {");
                     ...
                     if (var28.semPred != null) {
                        ActionTransInfo var30 = new ActionTransInfo();
                        String var17 = this.processActionForSpecialSymbols(var28.semPred, var1.line, this.currentRule, var30);
                     ...
                     if (var3 > 0) {
                        if (var28.synPred != null) {
                           this.println("else {");
                           ++this.tabs;
                           this.genSynPred(var28.synPred, var14);
                           ++var5;
                        } else {
                           this.println("else if " + var14 + " {");
                        }
                     } else if (var28.synPred != null) {
                        this.genSynPred(var28.synPred, var14);
                     } else {
                        if (this.grammar instanceof TreeWalkerGrammar) {
                           this.println("if (_t == " + this.labeledElementASTInit + " )");
   ...
   private void genElementAST(AlternativeElement var1) {
      if (this.grammar instanceof TreeWalkerGrammar && !this.grammar.buildAST) {
         ...
         if (this.grammar.buildAST && this.syntacticPredLevel == 0) {
            ...
            String var10 = var5 + "_AST";
            this.mapTreeVariable(var1, var10);
            if (this.grammar instanceof TreeWalkerGrammar) {
               this.println(this.labeledElementASTType + " " + var10 + "_in = " + this.labeledElementASTInit + ";");
            }
            ...
            if (var1.getLabel() != null) {
               if (var1 instanceof GrammarAtom) {
                  this.println(var10 + " = " + this.getASTCreateString((GrammarAtom)var1, var4) + ";");
               } else {
                  this.println(var10 + " = " + this.getASTCreateString(var4) + ";");
               }
            }
               ...
               switch (var1.getAutoGenType()) {
                  case 1:
                     if (!this.usingCustomAST && (!(var1 instanceof GrammarAtom) || ((GrammarAtom)var1).getASTNodeType() == null)) {
                        this.println("astFactory->addASTChild(currentAST, " + var10 + ");");
                     } else {
                        this.println("astFactory->addASTChild(currentAST, " + namespaceAntlr + "RefAST(" + var10 + "));");
                     }
                     break;
                  case 2:
                     if (!this.usingCustomAST && (!(var1 instanceof GrammarAtom) || ((GrammarAtom)var1).getASTNodeType() == null)) {
                        this.println("astFactory->makeASTRoot(currentAST, " + var10 + ");");
                     } else {
                        this.println("astFactory->makeASTRoot(currentAST, " + namespaceAntlr + "RefAST(" + var10 + "));");
                     }
               }
            }
   ...
   public void genInclude(LexerGrammar var1) throws IOException {
      ...
      if (this.grammar.superClass != null) {
         ...
         var6 = this.grammar.getSuperClass();
         if (var6.lastIndexOf(46) != -1) {
            var6 = var6.substring(var6.lastIndexOf(46) + 1);
         }

         this.println("#include <antlr/" + var6 + ".hpp>");
         var6 = namespaceAntlr + var6;
      }
      ...
      this.print("class CUSTOM_API " + this.grammar.getClassName() + " : public " + var6);
      ...
      for(Enumeration var8 = this.grammar.rules.elements(); var8.hasMoreElements(); this.exitIfError()) {
         RuleSymbol var5 = (RuleSymbol)var8.nextElement();
   ...
   public void genInclude(ParserGrammar var1) throws IOException {
      ...
      if (this.grammar.superClass != null) {
         ...
         this.println("#include <antlr/" + var7 + ".hpp>");
         var7 = namespaceAntlr + var7;
      }
      ...
      this.print("class CUSTOM_API " + this.grammar.getClassName() + " : public " + var7);
      this.println(", public " + this.grammar.tokenManager.getName() + TokenTypesFileSuffix);
      Token var3 = (Token)this.grammar.options.get("classHeaderSuffix");
      if (var3 != null) {
         String var4 = StringUtils.stripFrontBack(var3.getText(), "\"", "\"");
      ...
      for(Enumeration var9 = this.grammar.rules.elements(); var9.hasMoreElements(); this.exitIfError()) {
         GrammarSymbol var5 = (GrammarSymbol)var9.nextElement();
         if (var5 instanceof RuleSymbol) {
   ...
   public void genInclude(TreeWalkerGrammar var1) throws IOException {
      ...
      String var8;
      if (this.grammar.superClass != null) {
         var8 = this.grammar.superClass;
         this.println("\n// Include correct superclass header with a header statement for example:");
         this.println("// header \"post_include_hpp\" {");
         this.println("// #include \"" + var8 + ".hpp\"");
         this.println("// }");
         this.println("// Or....");
         this.println("// header {");
         this.println("// #include \"" + var8 + ".hpp\"");
         ...
         var8 = this.grammar.getSuperClass();
         if (var8.lastIndexOf(46) != -1) {
            var8 = var8.substring(var8.lastIndexOf(46) + 1);
         }

         this.println("#include <antlr/" + var8 + ".hpp>");
         var8 = namespaceAntlr + var8;
      }
      ...
      this.print("class CUSTOM_API " + this.grammar.getClassName() + " : public " + var8);
      this.println(", public " + this.grammar.tokenManager.getName() + TokenTypesFileSuffix);
      Token var3 = (Token)this.grammar.options.get("classHeaderSuffix");
      if (var3 != null) {
         String var4 = StringUtils.stripFrontBack(var3.getText(), "\"", "\"");
      ...
      for(String var5 = ""; var10.hasMoreElements(); this.exitIfError()) {
         GrammarSymbol var6 = (GrammarSymbol)var10.nextElement();
         if (var6 instanceof RuleSymbol) {
            RuleSymbol var7 = (RuleSymbol)var6;
   ...
   public void genNextToken() {
      ...
      for(int var2 = 0; var2 < this.grammar.rules.size(); ++var2) {
         RuleSymbol var3 = (RuleSymbol)this.grammar.rules.elementAt(var2);
      ...
      if (!var1) {
         ...
         RuleSymbol var10 = new RuleSymbol("mnextToken");
         var10.setDefined();
         var10.setBlock(var9);
         var10.access = "private";
         this.grammar.define(var10);
         ...
         for(int var11 = 0; var11 < var9.getAlternatives().size(); ++var11) {
            Alternative var7 = var9.getAlternativeAt(var11);
         ...
         CppBlockFinishingInfo var13 = this.genCommonBlock(var9, false);
         String var8 = "if (LA(1)==EOF_CHAR)" + var12 + "\t\t\t\t{" + var12 + "\t\t\t\t\tuponEOF();" + var12 + "\t\t\t\t\t_returnToken = makeToken(" + namespaceAntlr + "Token::EOF_TYPE);" + var12 + "\t\t\t\t}";
         var8 = var8 + var12 + "\t\t\t\t";
         if (((LexerGrammar)this.grammar).filterMode) {
            if (var5 == null) {
               var8 = var8 + "else {consume(); goto tryAgain;}";
            } else {
               var8 = var8 + "else {" + var12 + "\t\t\t\t\tcommit();" + var12 + "\t\t\t\t\ttry {m" + var5 + "(false);}" + var12 + "\t\t\t\t\tcatch(" + namespaceAntlr + "RecognitionException& e) {" + var12 + "\t\t\t\t\t\t// catastrophic failure" + var12 + "\t\t\t\t\t\treportError(e);" + var12 + "\t\t\t\t\t\tconsume();" + var12 + "\t\t\t\t\t}" + var12 + "\t\t\t\t\tgoto tryAgain;" + var12 + "\t\t\t\t}";
            }
         } else {
            var8 = var8 + "else {" + this.throwNoViable + "}";
         }

         this.genBlockFinish(var13, var8);
         if (((LexerGrammar)this.grammar).filterMode && var5 != null) {
            this.println("commit();");
         }

         this.println("if ( !_returnToken )" + var12 + "\t\t\t\tgoto tryAgain; // found SKIP token" + var12);
   ...
   public void genRule(RuleSymbol var1, boolean var2, int var3, String var4) {
      ...
      if (!var1.isDefined()) {
         ...
         if (var5.alternatives.size() == 1) {
            ...
            String var15 = var13.semPred;
            if (var15 != null) {
               this.genSemPred(var15, this.currentRule.line);
            }
            ...
            CppBlockFinishingInfo var16 = this.genCommonBlock(var5, false);
            this.genBlockFinish(var16, this.throwNoViable);
         }
         ...
         if (var12 != null) {
            ...
            if (!(this.grammar instanceof TreeWalkerGrammar)) {
               Lookahead var14 = this.grammar.theLLkAnalyzer.FOLLOW(1, var5.endNode);
               String var17 = this.getBitsetName(this.markBitsetForGen(var14.fset));
               this.println("recover(ex," + var17 + ");");
            } else {
               this.println("if ( _t != " + this.labeledElementASTInit + " )");
               ++this.tabs;
               this.println("_t = _t->getNextSibling();");
   ...
   protected String getLookaheadTestTerm(int var1, BitSet var2) {
      ...
      if (elementsAreRange(var4)) {
         ...
         if (var6 == 0) {
            return "true";
         } else if (var6 >= this.bitsetTestThreshold) {
            int var9 = this.markBitsetForGen(var2);
            return this.getBitsetName(var9) + ".member(" + var3 + ")";
         } else {
   ...
   private void setupGrammarParameters(Grammar var1) {
      if (var1 instanceof ParserGrammar || var1 instanceof LexerGrammar || var1 instanceof TreeWalkerGrammar) {
         ...
         if (var1.hasOption("namespace")) {
            Token var2 = var1.getOption("namespace");
            if (var2 != null) {
         ...
         if (var1.hasOption("namespaceAntlr")) {
            Token var4 = var1.getOption("namespaceAntlr");
            if (var4 != null) {
               String var3 = StringUtils.stripFrontBack(var4.getText(), "\"", "\"");
               if (var3 != null) {
         ...
         if (var1.hasOption("namespaceStd")) {
            Token var5 = var1.getOption("namespaceStd");
            if (var5 != null) {
               String var10 = StringUtils.stripFrontBack(var5.getText(), "\"", "\"");
               if (var10 != null) {
                  if (var10.length() > 2 && !var10.substring(var10.length() - 2, var10.length()).equals("::")) {
                     var10 = var10 + "::";
                  }
         ...
         if (var1.hasOption("genHashLines")) {
            Token var6 = var1.getOption("genHashLines");
            if (var6 != null) {
               String var11 = StringUtils.stripFrontBack(var6.getText(), "\"", "\"");
               this.genHashLines = var11.equals("true");
            }
         }

         this.noConstructors = this.antlrTool.noConstructors;
         if (var1.hasOption("noConstructors")) {
            Token var7 = var1.getOption("noConstructors");
            if (var7 != null && !var7.getText().equals("true") && !var7.getText().equals("false")) {
               this.antlrTool.error("noConstructors option must be true or false", this.antlrTool.getGrammarFile(), var7.getLine(), var7.getColumn());
            }

            this.noConstructors = var7.getText().equals("true");
         }
      }
      ...
      if (var1 instanceof ParserGrammar) {
         ...
         if (var1.hasOption("ASTLabelType")) {
            Token var8 = var1.getOption("ASTLabelType");
            if (var8 != null) {
               String var12 = StringUtils.stripFrontBack(var8.getText(), "\"", "\"");
               if (var12 != null) {
                  this.usingCustomAST = true;
                  this.labeledElementASTType = var12;
                  this.labeledElementASTInit = var12 + "(" + namespaceAntlr + "nullAST)";
               }
            }
         }
         ...
         this.lt1Value = "_t";
         if (var1.hasOption("ASTLabelType")) {
            Token var9 = var1.getOption("ASTLabelType");
            if (var9 != null) {
               String var13 = StringUtils.stripFrontBack(var9.getText(), "\"", "\"");
               if (var13 != null) {
                  this.usingCustomAST = true;
                  this.labeledElementASTType = var13;
                  this.labeledElementType = var13;
                  this.labeledElementInit = var13 + "(" + namespaceAntlr + "nullAST)";
                  this.labeledElementASTInit = this.labeledElementInit;
                  this.commonExtraParams = var13 + " _t";
