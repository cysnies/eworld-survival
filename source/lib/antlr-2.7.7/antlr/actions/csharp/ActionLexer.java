...
public class ActionLexer extends CharScanner implements ActionLexerTokenTypes, TokenStream {
   ...
   protected final void mAST_ITEM(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      if (this.LA(1) == '#' && this.LA(2) == '(') {
         ...
         } else if (var16.equals("define") || var16.equals("undef") || var16.equals("if") || var16.equals("elif") || var16.equals("else") || var16.equals("endif") || var16.equals("line") || var16.equals("error") || var16.equals("warning") || var16.equals("region") || var16.equals("endregion")) {
            this.text.setLength(var4);
      ...
      if (this.LA(1) == '$' && this.LA(2) == 'F' && this.LA(3) == 'O') {
         ...
         switch (this.LA(1)) {
            ...
            case '(':
               ...
               this.match(')');
               String var20 = "text.Append(" + var6.getText() + ")";
               this.text.setLength(var4);
         ...
         if (this.LA(1) == 'T' && this.LA(2) == 'e') {
            ...
            switch (this.LA(1)) {
               ...
               case '(':
                  ...
                  var7 = this._returnToken;
                  this.match(')');
                  String var19 = "text.Length = _begin; text.Append(" + var7.getText() + ")";
                  this.text.setLength(var4);
         ...
         case 'z':
            ...
            switch (this.LA(1)) {
               ...
               case ']':
                  ...
                  this.match(']');
                  this.text.setLength(var5);
                  String var9 = this.generator.processStringForASTConstructor(var22.getText());
                  if (var7 != null) {
   ...
   protected final void mTREE_ELEMENT(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      switch (this.LA(1)) {
         ...
         default:
            ...
            } else if (this.LA(1) == '#' && _tokenSet_13.member(this.LA(2))) {
               int var5 = this.text.length();
               this.match('#');
               this.text.setLength(var5);
