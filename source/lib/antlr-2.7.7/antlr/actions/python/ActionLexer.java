...
public class ActionLexer extends CharScanner implements ActionLexerTokenTypes, TokenStream {
   ...
   protected final void mAST_ITEM(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      if (this.LA(1) == '#' && this.LA(2) == '(') {
         ...
         String var10 = this.generator.mapTreeId(var16, this.transInfo);
         if (var10 != null) {
   ...
   protected final void mTEXT_ITEM(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      if (this.LA(1) == '$' && this.LA(2) == 's' && this.LA(3) == 'e') {
         ...
         if (this.LA(1) == 'T' && this.LA(2) == 'e') {
            ...
            switch (this.LA(1)) {
               ...
               case '(':
                  ...
                  var7 = this._returnToken;
                  this.match(')');
                  String var22 = "self.text.setLength(_begin) ; self.text.append(" + var7.getText() + ")";
                  this.text.setLength(var4);
                  this.text.append(var22);
                  break;
               default:
                  throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
            ...
            switch (this.LA(1)) {
               ...
               case '(':
                  ...
                  this.match(')');
                  String var21 = "_token = " + var8.getText();
                  this.text.setLength(var4);
                  this.text.append(var21);
                  break;
               default:
                  throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
            ...
            switch (this.LA(1)) {
               ...
               case '(':
                  ...
                  this.match(')');
                  String var20 = "_ttype = " + var9.getText();
                  this.text.setLength(var4);
         ...
         String var19 = this.currentRule.getRuleName();
         if (var10 != null) {
            var19 = var10.getText();
         }

         String var23 = this.generator.getFOLLOWBitSet(var19, 1);
         if (var23 == null) {
            this.reportError("$FOLLOW(" + var19 + ")" + ": unknown rule or bad lookahead computation");
         } else {
            this.text.setLength(var4);
         ...
         String var18 = this.currentRule.getRuleName();
         if (var11 != null) {
            var18 = var11.getText();
         }

         String var13 = this.generator.getFIRSTBitSet(var18, 1);
         if (var13 == null) {
            this.reportError("$FIRST(" + var18 + ")" + ": unknown rule or bad lookahead computation");
         } else {
            this.text.setLength(var4);
         ...
         switch (this.LA(1)) {
            ...
            case '(':
               ...
               this.match(')');
               String var12 = "self.text.append(" + var6.getText() + ")";
               this.text.setLength(var4);
         ...
         if (this.LA(1) == '$' && this.LA(2) == 'n' && this.LA(3) == 'l') {
            ...
            if (this.LA(1) != '$' || this.LA(2) != 'n' || this.LA(3) != 'e') {
               throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
   ...
   protected final void mTREE(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      switch (this.LA(1)) {
         ...
         case 'z':
            ...
            var10.appendElement(var19.getText());
            switch (this.LA(1)) {
               case '\t':
               case '\n':
               case '\r':
               ...
               case ',':
                  while(this.LA(1) == ',') {
                     ...
                     var10.appendElement(var20.getText());
                     switch (this.LA(1)) {
                        case '\t':
                        case '\n':
                        case '\r':
   ...
   protected final void mIGNWS(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      while(true) {
         while(this.LA(1) == ' ' && this.LA(2) >= 3 && this.LA(2) <= 255 && this.LA(3) >= 3 && this.LA(3) <= 255) {
            this.match(' ');
         }
