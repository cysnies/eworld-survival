...
class TokenQueue {
   ...
   public final void append(Token var1) {
   ...
   public final Token elementAt(int var1) {
      return this.buffer[this.offset + var1 & this.sizeLessOne];
   }

   private final void expand() {
      Token[] var1 = new Token[this.buffer.length * 2];
   ...
   private final void init(int var1) {
      this.buffer = new Token[var1];
