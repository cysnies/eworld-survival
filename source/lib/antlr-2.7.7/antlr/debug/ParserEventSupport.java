...
public class ParserEventSupport {
   ...
   public void fireDoneParsing() {
      ...
      synchronized(this) {
         ...
         var6 = (Hashtable)this.doneListeners.clone();
      }
      ...
      if (var6 != null) {
         ...
         while(var3.hasMoreElements()) {
            ListenerBase var7 = (ListenerBase)var3.nextElement();
            this.fireEvent(15, var7);
         }
      }
   ...
   public void fireEvents(int var1, Vector var2) {
      ...
      if (var2 != null) {
         for(int var4 = 0; var4 < var2.size(); ++var4) {
            ListenerBase var5 = (ListenerBase)var2.elementAt(var4);
            this.fireEvent(var1, var5);
         }
      }
