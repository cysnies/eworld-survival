...
public class ANTLRLexer extends CharScanner implements ANTLRTokenTypes, TokenStream {
               ...
               switch (this.LA(1)) {
                  ...
                  default:
                     if (this.LA(1) == '=' && this.LA(2) == '>') {
                        this.mIMPLIES(true);
                        Token var35 = this._returnToken;
                     } else if (this.LA(1) == '.' && this.LA(2) == '.') {
                        this.mRANGE(true);
                        Token var34 = this._returnToken;
                     } else if (this.LA(1) == '=') {
                        this.mASSIGN(true);
                        Token var32 = this._returnToken;
                     } else if (this.LA(1) == '.') {
                        this.mWILDCARD(true);
                        Token var33 = this._returnToken;
                     } else {
                        if (this.LA(1) != '\uffff') {
                  ...
                  case '!':
                     this.mBANG(true);
                     Token var30 = this._returnToken;
                     break;
                  case '"':
                     this.mSTRING_LITERAL(true);
                     Token var29 = this._returnToken;
                     break;
                  case '#':
                     this.mTREE_BEGIN(true);
                     Token var28 = this._returnToken;
                     break;
                  case '\'':
                     this.mCHAR_LITERAL(true);
                     Token var27 = this._returnToken;
                     break;
                  case '(':
                     this.mLPAREN(true);
                     Token var26 = this._returnToken;
                     break;
                  case ')':
                     this.mRPAREN(true);
                     Token var25 = this._returnToken;
                     break;
                  case '*':
                     this.mSTAR(true);
                     Token var24 = this._returnToken;
                     break;
                  case '+':
                     this.mPLUS(true);
                     Token var23 = this._returnToken;
                     break;
                  case ',':
                     this.mCOMMA(true);
                     Token var22 = this._returnToken;
                     break;
                  case '/':
                     this.mCOMMENT(true);
                     Token var21 = this._returnToken;
                     break;
                  case '0':
                  case '1':
                  case '2':
                  ...
                  case '{':
                     this.mACTION(true);
                     Token var10 = this._returnToken;
                     break;
                  case '|':
                     this.mOR(true);
                     Token var9 = this._returnToken;
                     break;
                  case '}':
                     this.mRCURLY(true);
                     Token var8 = this._returnToken;
                     break;
                  case '~':
                     this.mNOT_OP(true);
   ...
   public final void mRULE_REF(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      int var2 = 41;
      int var6 = 0;
      var6 = this.mINTERNAL_RULE_REF(false);
      var2 = var6;
      if (var6 == 51) {
         this.mWS_LOOP(false);
         if (this.LA(1) == '{') {
