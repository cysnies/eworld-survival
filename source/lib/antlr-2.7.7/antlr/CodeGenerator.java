   ...
   protected void setGrammar(Grammar var1) {
      ...
      if (this.grammar.hasOption("codeGenMakeSwitchThreshold")) {
         try {
            ...
            Token var3 = this.grammar.getOption("codeGenMakeSwitchThreshold");
      ...
      if (this.grammar.hasOption("codeGenBitsetTestThreshold")) {
         try {
            ...
            Token var6 = this.grammar.getOption("codeGenBitsetTestThreshold");
            this.antlrTool.error("option 'codeGenBitsetTestThreshold' must be an integer", this.grammar.getClassName(), var6.getLine(), var6.getColumn());
         }
      }
