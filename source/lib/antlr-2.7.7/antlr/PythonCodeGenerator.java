...
public class PythonCodeGenerator extends CodeGenerator {
   ...
   public void gen(LexerGrammar var1) throws IOException {
      ...
      this.println("class " + this.lexerClassName + "(" + var9 + ") :");
      ++this.tabs;
      this.printGrammarAction(this.grammar);
      this.println("def __init__(self, *argv, **kwargs) :");
      ++this.tabs;
      this.println(var9 + ".__init__(self, *argv, **kwargs)");
      ...
      if (this.grammar.debuggingOutput) {
         ...
         while(var11.hasMoreElements()) {
            GrammarSymbol var15 = (GrammarSymbol)var11.nextElement();
            if (var15 instanceof RuleSymbol) {
               this.println("\"" + ((RuleSymbol)var15).getId() + "\",");
            }
         }
      ...
      for(int var14 = 0; var12.hasMoreElements(); this.exitIfError()) {
         RuleSymbol var16 = (RuleSymbol)var12.nextElement();
         if (!var16.getId().equals("mnextToken")) {
            this.genRule(var16, false, var14++);
         }
      }
   ...
   public void gen(ParserGrammar var1) throws IOException {
      ...
      this.print("class " + this.parserClassName + "(" + var9);
      this.println("):");
      ++this.tabs;
      if (this.grammar.debuggingOutput) {
         ...
         while(var10.hasMoreElements()) {
            GrammarSymbol var7 = (GrammarSymbol)var10.nextElement();
      ...
      ++this.tabs;
      this.println(var9 + ".__init__(self, *args, **kwargs)");
      ...
      for(int var12 = 0; var11.hasMoreElements(); this.exitIfError()) {
         GrammarSymbol var13 = (GrammarSymbol)var11.nextElement();
         if (var13 instanceof RuleSymbol) {
            RuleSymbol var8 = (RuleSymbol)var13;
            this.genRule(var8, var8.references.size() == 0, var12++);
         }
      }
   ...
   public void gen(TreeWalkerGrammar var1) throws IOException {
      ...
      this.genJavadocComment(this.grammar);
      this.println("class " + this.treeWalkerClassName + "(" + var10 + "):");
      ++this.tabs;
      this.println("");
      this.println("# ctor ..");
      this.println("def __init__(self, *args, **kwargs):");
      ++this.tabs;
      this.println(var10 + ".__init__(self, *args, **kwargs)");
      this.println("self.tokenNames = _tokenNames");
      this.genHeaderInit(this.grammar);
      --this.tabs;
      this.println("");
   ...
   protected void genCases(BitSet var1) {
      ...
      if (!(this.grammar instanceof LexerGrammar)) {
         ...
         for(int var7 = 0; var7 < var2.length; ++var7) {
            this._print(this.getValueString(var2[var7], false));
   ...
   public PythonBlockFinishingInfo genCommonBlock(AlternativeBlock var1, boolean var2) {
      ...
      if (var1.not && this.analyzer.subruleCanBeInverted(var1, this.grammar instanceof LexerGrammar)) {
         ...
         this.println("self.match(" + var23 + this.getBitsetName(this.markBitsetForGen(var20.fset)) + ")");
         if (this.grammar instanceof TreeWalkerGrammar) {
            this.println("_t = _t.getNextSibling()");
         }
         ...
         for(int var11 = 0; var11 < var1.getAlternatives().size(); ++var11) {
         ...
         if (var19 >= this.makeSwitchThreshold) {
            String var21 = this.lookaheadString(1);
            var5 = true;
            if (this.grammar instanceof TreeWalkerGrammar) {
               this.println("if not _t:");
               ++this.tabs;
            ...
            for(int var24 = 0; var24 < var1.alternatives.size(); ++var24) {
               Alternative var13 = var1.getAlternativeAt(var24);
         ...
         int var22 = this.grammar instanceof LexerGrammar ? this.grammar.maxk : 0;

         for(int var25 = var22; var25 >= 0; --var25) {
            for(int var27 = 0; var27 < var1.alternatives.size(); ++var27) {
               Alternative var28 = var1.getAlternativeAt(var27);
               if (this.DEBUG_CODE_GENERATOR) {
                  System.out.println("genAlt: " + var27);
               }

               if (var5 && suitableForCaseExpression(var28)) {
                  if (this.DEBUG_CODE_GENERATOR) {
                  ...
                  String var15;
                  if (this.grammar instanceof LexerGrammar) {
                     int var17 = var28.lookaheadDepth;
                     if (var17 == Integer.MAX_VALUE) {
                        var17 = this.grammar.maxk;
                     }

                     while(var17 >= 1 && var28.cache[var17].containsEpsilon()) {
                        --var17;
                     }

                     if (var17 != var25) {
                        if (this.DEBUG_CODE_GENERATOR) {
                           System.out.println("ignoring alt because effectiveDepth!=altDepth" + var17 + "!=" + var25);
                        }
                        continue;
                     }

                     var16 = this.lookaheadIsEmpty(var28, var17);
                     var15 = this.getLookaheadTestExpression(var28, var17);
                  } else {
                     var16 = this.lookaheadIsEmpty(var28, this.grammar.maxk);
                     var15 = this.getLookaheadTestExpression(var28, this.grammar.maxk);
                  }
                  ...
                  if (var28.cache[1].fset.degree() > 127 && suitableForCaseExpression(var28)) {
                  ...
                  } else if (var16 && var28.semPred == null && var28.synPred == null) {
                     if (var4 == 0) {
                     ...
                     if (var28.semPred != null) {
                        ...
                        String var18 = this.processActionForSpecialSymbols(var28.semPred, var1.line, this.currentRule, var30);
                     ...
                     if (var4 > 0) {
                        if (var28.synPred != null) {
                           this.println("else:");
                           ++this.tabs;
                           this.genSynPred(var28.synPred, var15);
                           ++var6;
                        } else {
      ...
      if (this.grammar instanceof TreeWalkerGrammar && !this.grammar.buildAST) {
         ...
         if (this.grammar.buildAST && this.syntacticPredLevel == 0) {
            ...
            if (this.genAST) {
               switch (var1.getAutoGenType()) {
                  case 1:
                     this.println("self.addASTChild(currentAST, " + var10 + ")");
                     break;
                  case 2:
                     this.println("self.makeASTRoot(currentAST, " + var10 + ")");
               }
            }
   ...
   private void genErrorHandler(ExceptionSpec var1) {
      for(int var2 = 0; var2 < var1.handlers.size(); ++var2) {
         ...
         ActionTransInfo var10 = new ActionTransInfo();
         this.printAction(this.processActionForSpecialSymbols(var3.action.getText(), var3.action.getLine(), this.currentRule, var10));
         if (this.grammar.hasSyntacticPredicate) {
            --this.tabs;
            this.println("else:");
            ++this.tabs;
   ...
   public void genNextToken() {
      ...
      if (!var1) {
         ...
         RuleSymbol var12 = new RuleSymbol("mnextToken");
         var12.setDefined();
         var12.setBlock(var11);
         var12.access = "private";
         this.grammar.define(var12);
         ...
         for(int var15 = 0; var15 < var11.getAlternatives().size(); ++var15) {
            Alternative var8 = var11.getAlternativeAt(var15);
         ...
         PythonBlockFinishingInfo var17 = this.genCommonBlock(var11, false);
         String var18 = "";
         if (((LexerGrammar)this.grammar).filterMode) {
            if (var5 == null) {
               var18 = var18 + "self.filterdefault(self.LA(1))";
            } else {
               var18 = var18 + "self.filterdefault(self.LA(1), self.m" + var5 + ", False)";
            }
         } else {
            var18 = "self.default(self.LA(1))";
         }

         this.genBlockFinish1(var17, var18);
         this.tabs = var6;
      ...
      if (!var1.isDefined()) {
         ...
         if (var6 != null) {
            ...
            if (!(this.grammar instanceof TreeWalkerGrammar)) {
               ...
               this.println("self.consume()");
               this.println("self.consumeUntil(" + var12 + ")");
            } else {
               this.println("if _t:");
               ++this.tabs;
               this.println("_t = _t.getNextSibling()");
   ...
   protected String getLookaheadTestTerm(int var1, BitSet var2) {
      ...
      if (elementsAreRange(var4)) {
         ...
         if (var6 == 0) {
            ...
            int var11 = this.markBitsetForGen(var2);
            return this.getBitsetName(var11) + ".member(" + var3 + ")";
         } else {
   ...
   private String getValueString(int var1, boolean var2) {
      if (this.grammar instanceof LexerGrammar) {
         String var9 = this.charFormatter.literalChar(var1);
         if (var2) {
            var9 = "u'" + var9 + "'";
         }
   ...
   static boolean isEmpty(String param0) {
   ...
   private void setupGrammarParameters(Grammar var1) {
      if (var1 instanceof ParserGrammar) {
         ...
         if (var1.hasOption("ASTLabelType")) {
            Token var6 = var1.getOption("ASTLabelType");
            if (var6 != null) {
               String var10 = StringUtils.stripFrontBack(var6.getText(), "\"", "\"");
               if (var10 != null) {
                  this.labeledElementASTType = var10;
               }
            }
         }
         ...
         if (var1.hasOption("className")) {
            Token var7 = var1.getOption("className");
            if (var7 != null) {
               String var11 = StringUtils.stripFrontBack(var7.getText(), "\"", "\"");
               if (var11 != null) {
                  this.parserClassName = var11;
               }
            }
         }
         ...
         if (var1.hasOption("className")) {
            Token var5 = var1.getOption("className");
            if (var5 != null) {
               String var9 = StringUtils.stripFrontBack(var5.getText(), "\"", "\"");
               if (var9 != null) {
                  this.lexerClassName = var9;
               }
            }
         }
         ...
         if (var1.hasOption("className")) {
            Token var4 = var1.getOption("className");
            if (var4 != null) {
               String var8 = StringUtils.stripFrontBack(var4.getText(), "\"", "\"");
               if (var8 != null) {
                  this.treeWalkerClassName = var8;
               }
            }
         }
         ...
         for(int var9 = var4; var9 <= var5; ++var9) {
            ...
            switch (var10) {
               ...
               case ' ':
                  ...
                  break;
               default:
                  this.currentOutput.print(var10);
            }
