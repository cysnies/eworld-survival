...
public class JavaCodeGenerator extends CodeGenerator {
   ...
   public void gen(LexerGrammar var1) throws IOException {
      ...
      try {
         ...
         if (this.grammar.superClass != null) {
            var18 = this.grammar.superClass;
         } else {
            var18 = "antlr." + this.grammar.getSuperClass();
         }
         ...
         this.print(var4 + " ");
         this.print("class " + this.grammar.getClassName() + " extends " + var18);
         ...
         Enumeration var20 = this.grammar.tokenManager.getTokenSymbolKeys();

         while(var20.hasMoreElements()) {
            String var8 = (String)var20.nextElement();
            if (var8.charAt(0) == '"') {
         ...
         if (this.grammar.debuggingOutput) {
            ...
            Enumeration var21 = this.grammar.rules.elements();
            boolean var23 = false;

            while(var21.hasMoreElements()) {
               GrammarSymbol var25 = (GrammarSymbol)var21.nextElement();
               if (var25 instanceof RuleSymbol) {
                  this.println("  \"" + ((RuleSymbol)var25).getId() + "\",");
               }
            }
         ...
         this.genNextToken();
         Enumeration var22 = this.grammar.rules.elements();

         for(int var24 = 0; var22.hasMoreElements(); this.exitIfError()) {
            RuleSymbol var26 = (RuleSymbol)var22.nextElement();
            if (!var26.getId().equals("mnextToken")) {
               this.genRule(var26, false, var24++);
            }
         }
   ...
   public void gen(ParserGrammar var1) throws IOException {
      ...
      try {
         ...
         if (this.grammar.debuggingOutput) {
            ...
            while(var20.hasMoreElements()) {
               GrammarSymbol var9 = (GrammarSymbol)var20.nextElement();
         ...
         for(int var22 = 0; var21.hasMoreElements(); this.exitIfError()) {
            GrammarSymbol var23 = (GrammarSymbol)var21.nextElement();
            if (var23 instanceof RuleSymbol) {
               RuleSymbol var10 = (RuleSymbol)var23;
               this.genRule(var10, var10.references.size() == 0, var22++);
            }
         }
   ...
   public void gen(TreeWalkerGrammar var1) throws IOException {
      ...
      try {
         ...
         String var19;
         if (this.grammar.superClass != null) {
            var19 = this.grammar.superClass;
         } else {
            var19 = "antlr." + this.grammar.getSuperClass();
         }
         ...
         this.print(var4 + " ");
         this.print("class " + this.grammar.getClassName() + " extends " + var19);
         this.println("       implements " + this.grammar.tokenManager.getName() + TokenTypesFileSuffix);
         Token var20 = (Token)this.grammar.options.get("classHeaderSuffix");
         if (var20 != null) {
            String var7 = StringUtils.stripFrontBack(var20.getText(), "\"", "\"");
            if (var7 != null) {
               this.print(", " + var7);
            }
         }
         ...
         for(String var9 = ""; var21.hasMoreElements(); this.exitIfError()) {
            GrammarSymbol var10 = (GrammarSymbol)var21.nextElement();
      ...
      try {
         ...
         if (!var1.not || !this.analyzer.subruleCanBeInverted(var1, this.grammar instanceof LexerGrammar)) {
            if (var1.getAlternatives().size() == 1) {
               Alternative var28 = var1.getAlternativeAt(0);
               ...
               if (var2) {
                  if (var28.semPred != null) {
                     this.genSemPred(var28.semPred, var1.line);
                  }

                  this.genAlt(var28, var1);
                  JavaBlockFinishingInfo var33 = var7;
                  return var33;
               }
            }
            ...
            for(int var30 = 0; var30 < var1.getAlternatives().size(); ++var30) {
               Alternative var34 = var1.getAlternativeAt(var30);
               if (suitableForCaseExpression(var34)) {
                  ++var29;
               }
            }

            if (var29 >= this.makeSwitchThreshold) {
               String var31 = this.lookaheadString(1);
               var5 = true;
               if (this.grammar instanceof TreeWalkerGrammar) {
                  this.println("if (_t==null) _t=ASTNULL;");
               }

               this.println("switch ( " + var31 + ") {");

               for(int var35 = 0; var35 < var1.alternatives.size(); ++var35) {
                  Alternative var13 = var1.getAlternativeAt(var35);
            ...
            int var32 = this.grammar instanceof LexerGrammar ? this.grammar.maxk : 0;

            for(int var36 = var32; var36 >= 0; --var36) {
               if (this.DEBUG_CODE_GENERATOR) {
                  System.out.println("checking depth " + var36);
               }

               for(int var38 = 0; var38 < var1.alternatives.size(); ++var38) {
                  Alternative var41 = var1.getAlternativeAt(var38);
                  if (this.DEBUG_CODE_GENERATOR) {
                     System.out.println("genAlt: " + var38);
                  }

                  if (var5 && suitableForCaseExpression(var41)) {
                     if (this.DEBUG_CODE_GENERATOR) {
                     ...
                     String var15;
                     if (this.grammar instanceof LexerGrammar) {
                        int var17 = var41.lookaheadDepth;
                        if (var17 == Integer.MAX_VALUE) {
                           var17 = this.grammar.maxk;
                        }

                        while(var17 >= 1 && var41.cache[var17].containsEpsilon()) {
                           --var17;
                        }

                        if (var17 != var36) {
                           if (this.DEBUG_CODE_GENERATOR) {
                              System.out.println("ignoring alt because effectiveDepth!=altDepth;" + var17 + "!=" + var36);
                           }
                           continue;
                        }

                        var16 = this.lookaheadIsEmpty(var41, var17);
                        var15 = this.getLookaheadTestExpression(var41, var17);
                     } else {
                        var16 = this.lookaheadIsEmpty(var41, this.grammar.maxk);
                        var15 = this.getLookaheadTestExpression(var41, this.grammar.maxk);
                     }

                     int var43 = this.defaultLine;

                     try {
                        this.defaultLine = var41.head.getLine();
                        if (var41.cache[1].fset.degree() > 127 && suitableForCaseExpression(var41)) {
                           if (var4 == 0) {
                              this.println("if " + var15 + " {");
                           } else {
                              this.println("else if " + var15 + " {");
                           }
                        } else if (var16 && var41.semPred == null && var41.synPred == null) {
                           if (var4 == 0) {
                              this.println("{");
                           } else {
                              this.println("else {");
                           ...
                           if (var41.semPred != null) {
                              ActionTransInfo var18 = new ActionTransInfo();
                              String var19 = this.processActionForSpecialSymbols(var41.semPred, var1.line, this.currentRule, var18);
                           ...
                           if (var4 > 0) {
                              if (var41.synPred != null) {
                                 this.println("else {", var41.synPred.getLine());
                                 ++this.tabs;
                                 this.genSynPred(var41.synPred, var15);
                                 ++var6;
                              } else {
                                 this.println("else if " + var15 + " {");
                              }
                           } else if (var41.synPred != null) {
                              this.genSynPred(var41.synPred, var15);
                           } else {
                              if (this.grammar instanceof TreeWalkerGrammar) {
                                 this.println("if (_t==null) _t=ASTNULL;");
                        ...
                        this.defaultLine = var43;
                     }

                     ++var4;
                     ++this.tabs;
                     this.genAlt(var41, var1);
                     --this.tabs;
                     this.println("}");
                  }
               }
            ...
            for(int var39 = 1; var39 <= var6; ++var39) {
               var37 = var37 + "}";
            }
            ...
            JavaBlockFinishingInfo var40 = var7;
            return var40;
         }
         ...
         Lookahead var10 = this.analyzer.look(1, (AlternativeBlock)var1);
         if (var1.getLabel() != null && this.syntacticPredLevel == 0) {
            this.println(var1.getLabel() + " = " + this.lt1Value + ";");
         }
         ...
         this.println("match(" + var11 + this.getBitsetName(this.markBitsetForGen(var10.fset)) + ");");
         if (this.grammar instanceof TreeWalkerGrammar) {
            this.println("_t = _t.getNextSibling();");
         }
      ...
      try {
         ...
         if (!(this.grammar instanceof TreeWalkerGrammar) || this.grammar.buildAST) {
            if (this.grammar.buildAST && this.syntacticPredLevel == 0) {
               boolean var11 = this.genAST && (var1.getLabel() != null || var1.getAutoGenType() != 3);
               if (var1.getAutoGenType() != 3 && var1 instanceof TokenRefElement) {
                  var11 = true;
               }

               boolean var12 = this.grammar.hasSyntacticPredicate && var11;
               String var5;
               String var6;
               if (var1.getLabel() != null) {
                  var5 = var1.getLabel();
               ...
               String var14 = var6 + "_AST";
               this.mapTreeVariable(var1, var14);
               if (this.grammar instanceof TreeWalkerGrammar) {
                  this.println(this.labeledElementASTType + " " + var14 + "_in = null;");
               }
               ...
               if (var1.getLabel() != null) {
                  if (var1 instanceof GrammarAtom) {
                     this.println(var14 + " = " + this.getASTCreateString((GrammarAtom)var1, var5) + ";");
                  } else {
                     this.println(var14 + " = " + this.getASTCreateString(var5) + ";");
                  }
               }

               if (var1.getLabel() == null && var11) {
                  var5 = this.lt1Value;
                  if (var1 instanceof GrammarAtom) {
                     this.println(var14 + " = " + this.getASTCreateString((GrammarAtom)var1, var5) + ";");
                  } else {
               ...
               if (this.genAST) {
                  switch (var1.getAutoGenType()) {
                     case 1:
                        this.println("astFactory.addASTChild(currentAST, " + var14 + ");");
                        break;
                     case 2:
                        this.println("astFactory.makeASTRoot(currentAST, " + var14 + ");");
                  }
               }
         ...
         if (var1.getLabel() == null) {
            String var3 = this.lt1Value;
            String var4 = "tmp" + this.astVarNumber + "_AST";
            ++this.astVarNumber;
            this.mapTreeVariable(var1, var4);
            this.println(this.labeledElementASTType + " " + var4 + "_in = " + var3 + ";");
         }
      } finally {
         this.defaultLine = var2;
      }
   ...
   public void genNextToken() {
      ...
      try {
         ...
         for(int var3 = 0; var3 < this.grammar.rules.size(); ++var3) {
            RuleSymbol var4 = (RuleSymbol)this.grammar.rules.elementAt(var3);
         ...
         if (var2) {
            ...
            RuleSymbol var15 = new RuleSymbol("mnextToken");
            var15.setDefined();
            var15.setBlock(var14);
            var15.access = "private";
            this.grammar.define(var15);
            ...
            for(int var16 = 0; var16 < var14.getAlternatives().size(); ++var16) {
               Alternative var8 = var14.getAlternativeAt(var16);
            ...
            JavaBlockFinishingInfo var18 = this.genCommonBlock(var14, false);
            String var19 = "if (LA(1)==EOF_CHAR) {uponEOF(); _returnToken = makeToken(Token.EOF_TYPE);}";
            var19 = var19 + var17 + "\t\t\t\t";
            if (((LexerGrammar)this.grammar).filterMode) {
               if (var6 == null) {
                  var19 = var19 + "else {consume(); continue tryAgain;}";
               } else {
                  var19 = var19 + "else {" + var17 + "\t\t\t\t\tcommit();" + var17 + "\t\t\t\t\ttry {m" + var6 + "(false);}" + var17 + "\t\t\t\t\tcatch(RecognitionException e) {" + var17 + "\t\t\t\t\t\t// catastrophic failure" + var17 + "\t\t\t\t\t\treportError(e);" + var17 + "\t\t\t\t\t\tconsume();" + var17 + "\t\t\t\t\t}" + var17 + "\t\t\t\t\tcontinue tryAgain;" + var17 + "\t\t\t\t}";
               }
            } else {
               var19 = var19 + "else {" + this.throwNoViable + "}";
            }

            this.genBlockFinish(var18, var19, var14.getLine());
         ...
         try {
            ...
            if (var7 != null) {
               ...
               if (!(this.grammar instanceof TreeWalkerGrammar)) {
                  ...
                  String var15 = this.getBitsetName(this.markBitsetForGen(var13.fset));
                  this.println("recover(ex," + var15 + ");");
               } else {
   ...
   private void setupGrammarParameters(Grammar var1) {
      if (var1 instanceof ParserGrammar) {
         ...
         if (var1.hasOption("ASTLabelType")) {
            Token var2 = var1.getOption("ASTLabelType");
            if (var2 != null) {
               String var3 = StringUtils.stripFrontBack(var2.getText(), "\"", "\"");
               if (var3 != null) {
         ...
         if (var1.hasOption("ASTLabelType")) {
            Token var4 = var1.getOption("ASTLabelType");
            if (var4 != null) {
               String var5 = StringUtils.stripFrontBack(var4.getText(), "\"", "\"");
               if (var5 != null) {
                  this.labeledElementASTType = var5;
                  this.labeledElementType = var5;
               }
            }
         }
