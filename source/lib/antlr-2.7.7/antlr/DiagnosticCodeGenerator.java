...
public class DiagnosticCodeGenerator extends CodeGenerator {
   ...
   public void gen(LexerGrammar var1) throws IOException {
      ...
      while(var2.hasMoreElements()) {
         RuleSymbol var6 = (RuleSymbol)var2.nextElement();
         if (!var6.id.equals("mnextToken")) {
            this.genRule(var6);
         }
      }
   ...
   public void genLookaheadSetForBlock(AlternativeBlock var1) {
      ...
      for(int var5 = 1; var5 <= var2; ++var5) {
         Lookahead var6 = this.grammar.theLLkAnalyzer.look(var5, var1);
         this.printSet(var2, var5, var6);
      }
