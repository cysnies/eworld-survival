...
public class ASTFactory {
   ...
   public void setTokenTypeASTNodeType(int var1, String var2) throws IllegalArgumentException {
      ...
      if (var2 == null) {
         ...
         try {
            Class var6 = Utils.loadClass(var2);
            this.tokenTypeToASTClassMap.put(new Integer(var1), var6);
