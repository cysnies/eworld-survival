...
public class LLkAnalyzer implements LLkGrammarAnalyzer {
         ...
         for(int var7 = 0; var7 < var4 - 1; ++var7) {
            ...
            for(int var8 = var7 + 1; var8 < var4; ++var8) {
               ...
               do {
                  ...
                  Lookahead var11 = this.getAltLookahead(var1, var7, var2);
                  Lookahead var12 = this.getAltLookahead(var1, var8, var2);
                  if (this.DEBUG_ANALYZER) {
                  ...
                  var9[var2] = var11.intersection(var12);
                  if (this.DEBUG_ANALYZER) {
                     System.out.println("intersection at depth " + var2 + " is " + var9[var2].toString());
                  }
               ...
               } while(var10 && var2 <= this.grammar.maxk);
               ...
               if (var10) {
                  ...
                  var15.lookaheadDepth = Math.max(var15.lookaheadDepth, var2);
                  var16.lookaheadDepth = Math.max(var16.lookaheadDepth, var2);
               }
            }
         }
   ...
   public Lookahead look(int var1, RuleEndElement var2) {
      ...
      if (var2.noFOLLOW) {
         Lookahead var4 = new Lookahead();
         var4.setEpsilon();
         var4.epsilonDepth = BitSet.of(var1);
         return var4;
      } else {
         Lookahead var3 = this.FOLLOW(var1, var2);
         return var3;
      }
   }
