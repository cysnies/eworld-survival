...
public abstract class Grammar {
   ...
   public boolean setOption(String var1, Token var2) {
      ...
      if (var1.equals("k")) {
         ...
         return true;
      } else if (var1.equals("codeGenMakeSwitchThreshold")) {
         try {
            int var9 = this.getIntegerOption("codeGenMakeSwitchThreshold");
         ...
         try {
            int var4 = this.getIntegerOption("codeGenBitsetTestThreshold");
