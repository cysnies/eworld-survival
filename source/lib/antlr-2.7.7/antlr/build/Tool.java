   ...
   public void perform(String var1, String var2) {
      if (var1 != null && var2 != null) {
         ...
         if (var3 != null && var5 != null) {
            try {
               Method var11 = var3.getMethod(var2, class$antlr$build$Tool == null ? (class$antlr$build$Tool = class$("antlr.build.Tool")) : class$antlr$build$Tool);
               var11.invoke(var5, this);
   ...
   public void system(String var1) {
      ...
      try {
         ...
         if (!this.os.startsWith("Windows")) {
            var8 = var2.exec(new String[]{"sh", "-c", var1});
         } else {
            var8 = var2.exec(var1);
         }

         StreamScarfer var4 = new StreamScarfer(var8.getErrorStream(), "stderr", this);
         StreamScarfer var5 = new StreamScarfer(var8.getInputStream(), "stdout", this);
         var4.start();
         var5.start();
         int var6 = var8.waitFor();
