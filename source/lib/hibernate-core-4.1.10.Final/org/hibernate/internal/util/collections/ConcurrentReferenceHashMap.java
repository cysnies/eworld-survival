...
public class ConcurrentReferenceHashMap extends AbstractMap implements ConcurrentMap, Serializable {
   ...
   static final class Segment extends ReentrantLock implements Serializable {
      ...
      int rehash() {
         ...
         if (oldCapacity >= 1073741824) {
            ...
            HashEntry<K, V>[] newTable = ConcurrentReferenceHashMap.HashEntry.newArray(oldCapacity << 1);
            this.threshold = (int)((float)newTable.length * this.loadFactor);
      ...
      final void advance() {
         if (this.nextEntry == null || (this.nextEntry = this.nextEntry.next) == null) {
            ...
            while(this.nextSegmentIndex >= 0) {
               Segment<K, V> seg = ConcurrentReferenceHashMap.this.segments[this.nextSegmentIndex--];
               if (seg.count != 0) {
   ...
   final class EntrySet extends AbstractSet {
      ...
      public boolean contains(Object o) {
         if (!(o instanceof Map.Entry)) {
            ...
            Map.Entry<?, ?> e = (Map.Entry)o;
            V v = (V)ConcurrentReferenceHashMap.this.get(e.getKey());
