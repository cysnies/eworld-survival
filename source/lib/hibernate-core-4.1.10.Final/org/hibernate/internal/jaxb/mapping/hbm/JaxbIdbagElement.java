...
@XmlType(
   name = "idbag-element",
   propOrder = {"meta", "subselect", "cache", "synchronize", "comment", "collectionId", "key", "element", "manyToMany", "compositeElement", "manyToAny", "loader", "sqlInsert", "sqlUpdate", "sqlDelete", "sqlDeleteAll", "filter"}
)
public class JaxbIdbagElement extends IdBagPluralAttributeElementAdapter implements PluralAttributeElement {
   protected List meta;
   ...
   protected JaxbCollectionId collectionId;
   @XmlElement(
      required = true
   )
   ...
   public JaxbCollectionId getCollectionId() {
      return this.collectionId;
   }

   public void setCollectionId(JaxbCollectionId value) {
   ...
   @XmlType(
      name = "",
      propOrder = {"meta", "column", "generator"}
   )
