...
@XmlType(
   name = "primitive-array-element",
   propOrder = {"meta", "subselect", "cache", "synchronize", "comment", "key", "index", "listIndex", "element", "loader", "sqlInsert", "sqlUpdate", "sqlDelete", "sqlDeleteAll"}
)
public class JaxbPrimitiveArrayElement {
   ...
   public JaxbPrimitiveArrayElement() {
      super();
   }
