...
@XmlType(
   name = "union-subclass-element",
   propOrder = {"meta", "subselect", "synchronize", "comment", "tuplizer", "propertyOrManyToOneOrOneToOne", "unionSubclass", "loader", "sqlInsert", "sqlUpdate", "sqlDelete", "filter", "fetchProfile", "resultset", "queryOrSqlQuery"}
)
public class JaxbUnionSubclassElement implements SubEntityElement {
   ...
   public JaxbUnionSubclassElement() {
      super();
   }
