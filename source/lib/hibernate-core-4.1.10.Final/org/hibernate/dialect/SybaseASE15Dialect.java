...
public class SybaseASE15Dialect extends SybaseDialect {
   public SybaseASE15Dialect() {
      ...
      this.registerFunction("dateadd", new SQLFunctionTemplate(StandardBasicTypes.TIMESTAMP, "dateadd"));
      this.registerFunction("datediff", new SQLFunctionTemplate(StandardBasicTypes.INTEGER, "datediff"));
      this.registerFunction("datepart", new SQLFunctionTemplate(StandardBasicTypes.INTEGER, "datepart"));
   ...
   protected SqlTypeDescriptor getSqlTypeDescriptorOverride(int sqlCode) {
      return (SqlTypeDescriptor)(sqlCode == 16 ? TinyIntTypeDescriptor.INSTANCE : super.getSqlTypeDescriptorOverride(sqlCode));
   }
