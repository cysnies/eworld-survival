...
public final class LoggerFactory {
   ...
   private static Set findPossibleStaticLoggerBinderPathSet() {
      ...
      try {
         ClassLoader loggerFactoryClassLoader = (class$org$slf4j$LoggerFactory == null ? (class$org$slf4j$LoggerFactory = class$("org.slf4j.LoggerFactory")) : class$org$slf4j$LoggerFactory).getClassLoader();
         Enumeration paths;
