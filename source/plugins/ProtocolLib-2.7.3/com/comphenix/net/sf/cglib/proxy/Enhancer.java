...
public class Enhancer extends AbstractClassGenerator {
   ...
   private static void getMethods(Class superclass, Class[] interfaces, List methods, List interfaceMethods, Set forcePublic) {
      ...
      if (interfaces != null) {
         for(int i = 0; i < interfaces.length; ++i) {
            if (interfaces[i] != (class$net$sf$cglib$proxy$Factory == null ? (class$net$sf$cglib$proxy$Factory = class$("com.comphenix.net.sf.cglib.proxy.Factory")) : class$net$sf$cglib$proxy$Factory)) {
   ...
   protected Object nextInstance(Object instance) {
      ...
      if (this.classOnly) {
         ...
         return this.argumentTypes != null ? ((Factory)instance).newInstance(this.argumentTypes, this.arguments, this.callbacks) : ((Factory)instance).newInstance(this.callbacks);
      } else {
   ...
   private static Method getCallbacksSetter(Class type, String methodName) throws NoSuchMethodException {
      return type.getDeclaredMethod(methodName, array$Lnet$sf$cglib$proxy$Callback == null ? (array$Lnet$sf$cglib$proxy$Callback = class$("[Lcom.comphenix.net.sf.cglib.proxy.Callback;")) : array$Lnet$sf$cglib$proxy$Callback);
   }
   ...
   static {
      SOURCE = new AbstractClassGenerator.Source((class$net$sf$cglib$proxy$Enhancer == null ? (class$net$sf$cglib$proxy$Enhancer = class$("com.comphenix.net.sf.cglib.proxy.Enhancer")) : class$net$sf$cglib$proxy$Enhancer).getName());
      KEY_FACTORY = (EnhancerKey)KeyFactory.create(class$net$sf$cglib$proxy$Enhancer$EnhancerKey == null ? (class$net$sf$cglib$proxy$Enhancer$EnhancerKey = class$("com.comphenix.net.sf.cglib.proxy.Enhancer$EnhancerKey")) : class$net$sf$cglib$proxy$Enhancer$EnhancerKey);
      FACTORY = TypeUtils.parseType("com.comphenix.net.sf.cglib.proxy.Factory");
      ...
      CALLBACK = TypeUtils.parseType("com.comphenix.net.sf.cglib.proxy.Callback");
      CALLBACK_ARRAY = Type.getType(array$Lnet$sf$cglib$proxy$Callback == null ? (array$Lnet$sf$cglib$proxy$Callback = class$("[Lcom.comphenix.net.sf.cglib.proxy.Callback;")) : array$Lnet$sf$cglib$proxy$Callback);
