...
public class EmitUtils {
   ...
   private static Class remapComponentType(Class componentType) {
      if (componentType.equals(class$org$objectweb$asm$Type == null ? (class$org$objectweb$asm$Type = class$("com.comphenix.net.sf.cglib.asm.Type")) : class$org$objectweb$asm$Type)) {
         return class$java$lang$Class == null ? (class$java$lang$Class = class$("java.lang.Class")) : class$java$lang$Class;
      } else {
   ...
   public static void wrap_undeclared_throwable(CodeEmitter e, Block handler, Type[] exceptions, Type wrapper) {
      Set set = (Set)(exceptions == null ? Collections.EMPTY_SET : new HashSet(Arrays.asList(exceptions)));
