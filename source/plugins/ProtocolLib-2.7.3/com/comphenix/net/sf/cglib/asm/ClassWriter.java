...
public class ClassWriter implements ClassVisitor {
   ...
   public byte[] toByteArray() {
      ...
      for(FieldWriter var3 = this.y; var3 != null; var3 = var3.a) {
         ++var2;
         var1 += var3.a();
      }
      ...
      for(MethodWriter var5 = this.A; var5 != null; var5 = var5.a) {
         ++var4;
         var1 += var5.a();
      }
      ...
      for(FieldWriter var11 = this.y; var11 != null; var11 = var11.a) {
         var11.a(var7);
      }

      var7.putShort(var4);

      for(MethodWriter var12 = this.A; var12 != null; var12 = var12.a) {
         var12.a(var7);
      }
      ...
      if (this.I) {
         ClassWriter var14 = new ClassWriter(2);
         (new ClassReader(var7.a)).accept(var14, 4);
   ...
   Item a(Object var1) {
      if (var1 instanceof Integer) {
         int var10 = (Integer)var1;
         return this.a(var10);
      } else if (var1 instanceof Byte) {
         int var9 = ((Byte)var1).intValue();
         return this.a(var9);
      } else if (var1 instanceof Character) {
         char var8 = (Character)var1;
         return this.a(var8);
      } else if (var1 instanceof Short) {
         int var7 = ((Short)var1).intValue();
         return this.a(var7);
      } else if (var1 instanceof Boolean) {
         int var6 = (Boolean)var1 ? 1 : 0;
         return this.a(var6);
   ...
   int a(String var1, int var2) {
      ...
      this.g.c = var2;
      this.g.g = var1;
      this.g.j = Integer.MAX_VALUE & 14 + var1.hashCode() + var2;
      Item var3 = this.a(this.g);
      if (var3 == null) {
         var3 = this.c(this.g);
      }
   ...
   int a(int var1, int var2) {
      ...
      this.h.j = Integer.MAX_VALUE & 15 + var1 + var2;
      Item var3 = this.a(this.h);
      if (var3 == null) {
