...
public abstract class KeyFactory {
   ...
   private static final Type KEY_FACTORY = TypeUtils.parseType("com.comphenix.net.sf.cglib.core.KeyFactory");
   ...
   public static class Generator extends AbstractClassGenerator {
      ...
      public void generateClass(ClassVisitor v) {
         ...
         if (!newInstance.getReturnType().equals(KeyFactory.class$java$lang$Object == null ? (KeyFactory.class$java$lang$Object = KeyFactory.class$("java.lang.Object")) : KeyFactory.class$java$lang$Object)) {
            ...
            for(int i = 0; i < parameterTypes.length; ++i) {
               ...
               ce.declare_field(18, this.getFieldName(i), parameterTypes[i], (Object)null);
               e.dup();
               e.load_arg(i);
      ...
      static {
         SOURCE = new AbstractClassGenerator.Source((KeyFactory.class$net$sf$cglib$core$KeyFactory == null ? (KeyFactory.class$net$sf$cglib$core$KeyFactory = KeyFactory.class$("com.comphenix.net.sf.cglib.core.KeyFactory")) : KeyFactory.class$net$sf$cglib$core$KeyFactory).getName());
      }
   }
}
