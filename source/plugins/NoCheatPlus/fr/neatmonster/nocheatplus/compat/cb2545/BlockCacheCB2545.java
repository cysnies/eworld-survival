...
public class BlockCacheCB2545 extends BlockCache implements IBlockAccess {
   ...
   public BlockCacheCB2545(org.bukkit.World world) {
      super();
   ...
   public boolean standsOnEntity(Entity entity, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
      try {
         ...
         for(net.minecraft.server.v1_4_6.Entity other : this.world.getEntities(mcEntity, box)) {
            EntityType type = other.getBukkitEntity().getType();
