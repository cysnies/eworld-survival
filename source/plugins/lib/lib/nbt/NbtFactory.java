...
public class NbtFactory {
   ...
   // $FF: synthetic field
   private static int[] $SWITCH_TABLE$lib$nbt$NbtFactory$NbtType;
   ...
   // $FF: synthetic method
   static int[] $SWITCH_TABLE$lib$nbt$NbtFactory$NbtType() {
      int[] var10000 = $SWITCH_TABLE$lib$nbt$NbtFactory$NbtType;
      if (var10000 != null) {
         return var10000;
      } else {
         ...
         $SWITCH_TABLE$lib$nbt$NbtFactory$NbtType = var0;
         return var0;
      }
   }
