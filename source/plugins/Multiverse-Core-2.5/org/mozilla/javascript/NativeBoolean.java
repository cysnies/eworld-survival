...
final class NativeBoolean extends IdScriptableObject {
   ...
   public Object getDefaultValue(Class typeHint) {
      return typeHint == ScriptRuntime.BooleanClass ? ScriptRuntime.wrapBoolean(this.booleanValue) : super.getDefaultValue(typeHint);
   }
   ...
   public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
      if (!f.hasTag(BOOLEAN_TAG)) {
         ...
         if (id != 1) {
            ...
            return thisObj == null ? new NativeBoolean(b) : ScriptRuntime.wrapBoolean(b);
         }
      }
   }
