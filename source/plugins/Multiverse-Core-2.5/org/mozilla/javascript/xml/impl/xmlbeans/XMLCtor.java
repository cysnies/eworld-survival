...
class XMLCtor extends IdFunctionObject {
   ...
   protected void setInstanceIdValue(int id, Object value) {
      switch (id - super.getMaxInstanceId()) {
         case 1:
            this.lib.ignoreComments = ScriptRuntime.toBoolean(value);
            return;
         case 2:
            this.lib.ignoreProcessingInstructions = ScriptRuntime.toBoolean(value);
            return;
         case 3:
            this.lib.ignoreWhitespace = ScriptRuntime.toBoolean(value);
            return;
         case 4:
            this.lib.prettyIndent = ScriptRuntime.toInt32(value);
            return;
         case 5:
            this.lib.prettyPrinting = ScriptRuntime.toBoolean(value);
            return;
         default:
