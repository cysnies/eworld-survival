         ...
         if (me.getModifiers() == 0 || (me.getModifiers() & 1040) != 0 && (me.getModifiers() & 6863) == 0) {
            ...
            for(int counter = this.getColumnCount() - 1; counter >= 0; --counter) {
               if (TreeTableModel.class == this.getColumnClass(counter)) {
                  MouseEvent newME = new MouseEvent(this.tree, me.getID(), me.getWhen(), me.getModifiers(), me.getX() - this.getCellRect(row, counter, true).x, me.getY(), me.getClickCount(), me.isPopupTrigger());
