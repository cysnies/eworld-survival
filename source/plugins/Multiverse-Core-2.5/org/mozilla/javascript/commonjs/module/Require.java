...
public class Require extends BaseFunction {
   ...
   private static final ThreadLocal loadingModuleInterfaces = new ThreadLocal();
   ...
   public Scriptable requireMain(Context cx, String mainModuleId) {
      if (this.mainModuleId != null) {
         ...
         if (moduleScript != null) {
            ...
            this.mainExports = this.getExportedModuleInterface(cx, mainUri.toString(), mainUri, (URI)null, true);
         }
   ...
   private Scriptable getExportedModuleInterface(Context cx, String id, URI uri, URI base, boolean isMain) {
      Scriptable exports = (Scriptable)this.exportedModuleInterfaces.get(id);
      if (exports != null) {
         if (isMain) {
         ...
         synchronized(this.loadLock) {
            exports = (Scriptable)this.exportedModuleInterfaces.get(id);
            if (exports != null) {
               return exports;
            } else {
               ...
               if (this.sandboxed && !moduleScript.isSandboxed()) {
                  ...
                  try {
                     ...
                     if (outermostLocked) {
                        ...
                        loadingModuleInterfaces.set((Object)null);
                     }
   ...
   private Scriptable executeModuleScript(Context cx, String id, Scriptable exports, ModuleScript moduleScript, boolean isMain) {
      ...
      return ScriptRuntime.toObject(this.nativeScope, ScriptableObject.getProperty(moduleObject, "exports"));
   }
