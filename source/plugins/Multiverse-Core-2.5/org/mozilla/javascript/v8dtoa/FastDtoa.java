...
public class FastDtoa {
   ...
   static boolean roundWeed(FastDtoaBuilder buffer, long distance_too_high_w, long unsafe_interval, long rest, long ten_kappa, long unit) {
      ...
      long big_distance;
      for(big_distance = distance_too_high_w + unit; rest < small_distance && unsafe_interval - rest >= ten_kappa && (rest + ten_kappa < small_distance || small_distance - rest >= rest + ten_kappa - small_distance); rest += ten_kappa) {
         buffer.decreaseLast();
      }
