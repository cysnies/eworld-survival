...
class JavaMembers {
   ...
   private static void discoverAccessibleMethods(Class clazz, Map map, boolean includeProtected, boolean includePrivate) {
   ...
   private void reflect(Scriptable scope, boolean includeProtected, boolean includePrivate) {
      ...
      Field[] fields = this.getAccessibleFields(includeProtected, includePrivate);
   ...
   private MemberBox findGetter(boolean isStatic, Map ht, String prefix, String propertyName) {
   ...
   Map getFieldAndMethodsObjects(Scriptable scope, Object javaObject, boolean isStatic) {
