...
public final class OptRuntime extends ScriptRuntime {
   public static final Double zeroObj = new Double((double)0.0F);
   public static final Double oneObj = new Double((double)1.0F);
   public static final Double minusOneObj = new Double((double)-1.0F);
   ...
   public static Object add(Object val1, double val2) {
      ...
      return !(val1 instanceof CharSequence) ? wrapDouble(toNumber(val1) + val2) : new ConsString((CharSequence)val1, toString(val2));
   }
   ...
   public static Object add(double val1, Object val2) {
      ...
      return !(val2 instanceof CharSequence) ? wrapDouble(toNumber(val2) + val1) : new ConsString(toString(val1), (CharSequence)val2);
   }
   ...
   public static Double wrapDouble(double num) {
      if (num == (double)0.0F) {
         if ((double)1.0F / num > (double)0.0F) {
            return zeroObj;
         }
      } else {
         if (num == (double)1.0F) {
