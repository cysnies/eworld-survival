...
public class Codegen implements Evaluator {
   ...
   private RuntimeException reportClassFileFormatException(ScriptNode scriptOrFn, String message) {
      ...
      return Context.reportRuntimeError(msg, scriptOrFn.getSourceName(), scriptOrFn.getLineno(), (String)null, 0);
   }
            ...
            for(int i = 0; i != count; ++i) {
               ...
               switch (methodIndex) {
                  ...
                  case 4:
                     ...
                     break;
                  case 5:
                     int name = n.getParamAndVarCount();
                     ...
                     if (name == 0) {
                        ...
                        cfw.addILoad(1);
                        int paramSwitchStart = cfw.addTableSwitch(1, name - 1);
   ...
   private static String getStaticConstantWrapperType(double num) {
      int inum = (int)num;
      return (double)inum == num ? "Ljava/lang/Integer;" : "Ljava/lang/Double;";
   }
