...
public class ClassCompiler {
   ...
   public Class[] getTargetImplements() {
      return this.targetImplements == null ? null : (Class[])((Class[])this.targetImplements.clone());
   }

   public void setTargetImplements(Class[] implementsClasses) {
      this.targetImplements = implementsClasses == null ? null : (Class[])((Class[])((Class;)implementsClasses).clone());
   }
