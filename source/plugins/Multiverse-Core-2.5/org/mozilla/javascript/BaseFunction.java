...
public class BaseFunction extends IdScriptableObject implements Function {
   ...
   protected Scriptable getClassPrototype() {
      ...
      return protoVal instanceof Scriptable ? (Scriptable)protoVal : ScriptableObject.getObjectPrototype(this);
   }
   ...
   public Scriptable construct(Context cx, Scriptable scope, Object[] args) {
      ...
      if (result != null) {
         ...
         Object val = this.call(cx, scope, (Scriptable)null, args);
         if (!(val instanceof Scriptable)) {
         ...
         if (result.getPrototype() == null) {
            Scriptable proto = this.getClassPrototype();
            if (result != proto) {
   ...
   private static Object jsConstructor(Context cx, Scriptable scope, Object[] args) {
      ...
      if (evaluator == null) {
         ...
         return cx.compileFunction(global, source, evaluator, reporter, sourceURI, 1, (Object)null);
      }
   }
