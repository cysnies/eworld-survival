...
final class InterpretedFunction extends NativeFunction implements Script {
   ...
   public Object call(Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
      return !ScriptRuntime.hasTopCall(cx) ? ScriptRuntime.doTopCall(this, cx, scope, thisObj, args) : Interpreter.interpret(this, cx, scope, thisObj, args);
   }
   ...
   public Object exec(Context cx, Scriptable scope) {
      if (!this.isScript()) {
         ...
         return !ScriptRuntime.hasTopCall(cx) ? ScriptRuntime.doTopCall(this, cx, scope, scope, ScriptRuntime.emptyArgs) : Interpreter.interpret(this, cx, scope, scope, ScriptRuntime.emptyArgs);
      }
   }
