...
public enum ProtectConfig {
   ...
   private ProtectConfig(String configName) {
      this(configName, (String)null, false, true, false);
   }

   private ProtectConfig(String configName, String defValueString) {
      this(configName, defValueString, false, false, true);
   }

   private ProtectConfig(String configName, boolean defValueBoolean) {
      this(configName, (String)null, defValueBoolean, false, false);
   }

   private ProtectConfig(String configName, String defValueString, boolean defValueBoolean, boolean isList, boolean isString) {
