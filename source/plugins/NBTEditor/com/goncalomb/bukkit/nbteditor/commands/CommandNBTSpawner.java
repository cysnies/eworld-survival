...
public class CommandNBTSpawner extends BetterCommand {
   public CommandNBTSpawner() {
      ...
      this.setAlises(new String[]{"nbts"});
      this.setDescription(Lang._("nbt.cmds.nbts.description"));
   }
   ...
   private static int parseIndex(String str, List entities) throws BetterCommandException {
   ...
   public boolean setposCommand(CommandSender sender, String[] args) throws BetterCommandException {
      ...
      if (args.length == 4) {
         ...
         EntityNBT entityNBT = ((SpawnerEntityNBT)entities.get(index - 1)).getEntityNBT();
   ...
   public boolean seeCommand(CommandSender sender, String[] args) throws BetterCommandException {
      ...
      (new InventoryForSpawnerEntities(player, spawner)).openInventory(player, this.getPlugin());
      return true;
   }
   ...
   public boolean copyCommand(CommandSender sender, String[] args) throws BetterCommandException {
      ...
      player.setMetadata("NBTEditor-spawner", new FixedMetadataValue(this.getPlugin(), clipboard));
   ...
   public boolean pasteCommand(CommandSender sender, String[] args) throws BetterCommandException {
      ...
      if (player.hasMetadata("NBTEditor-spawner")) {
         SpawnerNBTWrapper spawner = getSpawner(player);
         spawner.cloneFrom((SpawnerNBTWrapper)((MetadataValue)player.getMetadata("NBTEditor-spawner").get(0)).value());
         spawner.save();
