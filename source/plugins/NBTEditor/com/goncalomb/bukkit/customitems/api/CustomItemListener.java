...
abstract class CustomItemListener extends CustomItemContainer implements Listener {
   CustomItemListener() {
      super();
   }

   protected final boolean isOverriden(CustomItem item, String methodName, Class... methodParams) throws NoSuchMethodException {
      return this.isOverriden(item, CustomItem.class, methodName, methodParams);
   }

   protected final boolean isOverriden(CustomItem item, Class baseClass, String methodName, Class... methodParams) throws NoSuchMethodException {
