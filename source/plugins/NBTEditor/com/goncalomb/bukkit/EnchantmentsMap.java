...
public final class EnchantmentsMap {
   private static final HashMap _enchantmentNames = new HashMap();
   private static final String _enchantmentStringList;
   ...
   public static Enchantment getByName(String name) {
      return (Enchantment)_enchantmentNames.get(name.toLowerCase());
   }
