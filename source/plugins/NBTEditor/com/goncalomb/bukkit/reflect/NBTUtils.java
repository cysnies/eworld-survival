...
public final class NBTUtils {
   ...
   private static Method _e0;
   private static Method _f0;
   private static Method _a0;
   private static Method _getHandle;
   private static Method _b1;
   private static Method _a1;
   ...
   static void prepareReflection() throws SecurityException, NoSuchMethodException, NoSuchFieldException {
      ...
      _getTileEntity = craftWorldClass.getMethod("getTileEntityAt", Integer.TYPE, Integer.TYPE, Integer.TYPE);
   }
   ...
   public static ItemStack itemStackFromNBTTagCompound(NBTTagCompoundWrapper data) {
      ...
      return (ItemStack)BukkitReflect.invokeMethod((Object)null, _asBukkitCopy, BukkitReflect.invokeMethod((Object)null, _createStack, data._nbtBaseObject));
   }
   ...
   public static NBTTagCompoundWrapper nbtTagCompoundFromItemStack(ItemStack stack) {
      ...
      BukkitReflect.invokeMethod(BukkitReflect.invokeMethod((Object)null, _asNMSCopy, stack), _save, data._nbtBaseObject);
      return data;
   }
   ...
   public static NBTTagListWrapper effectsListFromPotion(ItemStack potion) {
      NBTBaseWrapper.prepareReflection();
      Object tagObject = BukkitReflect.invokeMethod(BukkitReflect.invokeMethod((Object)null, _asNMSCopy, potion), _getTag);
      if (tagObject != null) {
   ...
   public static ItemStack getGenericPotionFromEffectList(NBTTagListWrapper effectList) {
      ...
      data.setShort("Damage", (new Potion(PotionType.SPEED, 1)).toDamageValue());
