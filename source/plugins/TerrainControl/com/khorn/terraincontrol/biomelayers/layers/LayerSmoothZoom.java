...
public class LayerSmoothZoom extends Layer {
   ...
   public int[] GetBiomes(int cacheId, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
      ...
      for(int i1 = 0; i1 < m - 1; ++i1) {
         ...
         for(int i6 = 0; i6 < k - 1; ++i6) {
            ...
            arrayOfInt2[i3] = i4;
            arrayOfInt2[i3++ + n] = i4 + (i5 - i4) * this.nextInt(256) / 256;
            arrayOfInt2[i3] = i4 + (i7 - i4) * this.nextInt(256) / 256;
            int i9 = i4 + (i7 - i4) * this.nextInt(256) / 256;
            int i10 = i5 + (i8 - i5) * this.nextInt(256) / 256;
            arrayOfInt2[i3++ + n] = i9 + (i10 - i9) * this.nextInt(256) / 256;
            i4 = i7;
            i5 = i8;
         }
      }
   ...
   public static Layer a(long paramLong, Layer paramGenLayer, int paramInt) {
      ...
      for(int i = 0; i < paramInt; ++i) {
         localObject = new LayerSmoothZoom(paramLong + (long)i, localObject);
      }
