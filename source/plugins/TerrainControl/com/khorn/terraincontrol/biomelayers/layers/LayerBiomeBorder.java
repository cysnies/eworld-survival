   ...
   public int[] GetBiomes(int cacheId, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
      ...
      for(int i = 0; i < paramInt4; ++i) {
         for(int j = 0; j < paramInt3; ++j) {
            this.SetSeed((long)(j + paramInt1), (long)(i + paramInt2));
            ...
            if (this.BordersFrom[biomeId] != null) {
               ...
               if (biomeFrom[i1] && biomeFrom[i2] && biomeFrom[i3] && biomeFrom[i4] && (i1 != biomeId || i2 != biomeId || i3 != biomeId || i4 != biomeId)) {
                  currentPiece = currentPiece & 7680 | 256 | this.BordersTo[biomeId];
               }
            }
