...
public enum DefaultMaterial {
   ...
   private static DefaultMaterial[] lookupID = new DefaultMaterial[256];
   private static Map lookupName = new HashMap();
   ...
   public static DefaultMaterial getMaterial(String name) {
      return (DefaultMaterial)lookupName.get(name);
   }
   ...
   public static DefaultMaterial getMaterial(int id) {
      return id < 256 && lookupID[id] != null ? lookupID[id] : UNKNOWN_BLOCK;
   }

   static {
      for(DefaultMaterial material : values()) {
