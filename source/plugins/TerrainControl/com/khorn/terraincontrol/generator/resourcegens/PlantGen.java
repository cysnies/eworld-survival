...
public class PlantGen extends Resource {
   ...
   public void spawn(LocalWorld world, Random rand, boolean villageInChunk, int x, int z) {
      ...
      for(int i = 0; i < 64; ++i) {
         ...
         if (world.isEmpty(j, k, m) && this.sourceBlocks.contains(world.getTypeId(j, k - 1, m))) {
            world.setBlock(j, k, m, this.blockId, this.blockData, false, false, false);
         }
      }
   ...
   public String makeString() {
      return "Plant(" + this.makeMaterial(this.blockId, this.blockData) + "," + this.frequency + "," + this.rarity + "," + this.minAltitude + "," + this.maxAltitude + this.makeMaterial(this.sourceBlocks) + ")";
   }
}
