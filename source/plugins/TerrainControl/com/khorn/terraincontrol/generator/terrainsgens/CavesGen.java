...
public class CavesGen extends TerrainGenBase {
   ...
   protected void a(long paramLong, int paramInt1, int paramInt2, byte[] paramArrayOfByte, double paramDouble1, double paramDouble2, double paramDouble3) {
      this.a(paramLong, paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, 1.0F + this.c.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, (double)0.5F);
   }
   ...
   protected void a(long paramLong, int paramInt1, int paramInt2, byte[] paramArrayOfByte, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2, float paramFloat3, int paramInt3, int paramInt4, double paramDouble4) {
      double d1 = (double)(paramInt1 * 16 + 8);
      double d2 = (double)(paramInt2 * 16 + 8);
      float f1 = 0.0F;
      float f2 = 0.0F;
      ...
      for(int k = localRandom.nextInt(6) == 0 ? 1 : 0; paramInt3 < paramInt4; ++paramInt3) {
         double d3 = (double)1.5F + (double)(MathHelper.sin((float)paramInt3 * 3.141593F / (float)paramInt4) * paramFloat1 * 1.0F);
         double d4 = d3 * paramDouble4;
         float f3 = MathHelper.cos(paramFloat3);
         float f4 = MathHelper.sin(paramFloat3);
         paramDouble1 += (double)(MathHelper.cos(paramFloat2) * f3);
         paramDouble2 += (double)f4;
         paramDouble3 += (double)(MathHelper.sin(paramFloat2) * f3);
         if (k != 0) {
            paramFloat3 *= 0.92F;
         } else {
            paramFloat3 *= 0.7F;
         ...
         if (i == 0 && paramInt3 == j && paramFloat1 > 1.0F && paramInt4 > 0) {
            this.a(localRandom.nextLong(), paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 - 1.570796F, paramFloat3 / 3.0F, paramInt3, paramInt4, (double)1.0F);
            this.a(localRandom.nextLong(), paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 + 1.570796F, paramFloat3 / 3.0F, paramInt3, paramInt4, (double)1.0F);
            return;
         }
         ...
         if (i != 0 || localRandom.nextInt(4) != 0) {
            ...
            double d7 = (double)(paramInt4 - paramInt3);
            ...
            if (!(paramDouble1 < d1 - (double)16.0F - d3 * (double)2.0F) && !(paramDouble3 < d2 - (double)16.0F - d3 * (double)2.0F) && !(paramDouble1 > d1 + (double)16.0F + d3 * (double)2.0F) && !(paramDouble3 > d2 + (double)16.0F + d3 * (double)2.0F)) {
               ...
               for(int i6 = m; i5 == 0 && i6 < n; ++i6) {
                  for(int i7 = i3; i5 == 0 && i7 < i4; ++i7) {
                     for(int i8 = i2 + 1; i5 == 0 && i8 >= i1 - 1; --i8) {
                        int i9 = (i6 * 16 + i7) * this.worldSettings.WorldHeight + i8;
                        if (i8 >= 0 && i8 < this.worldSettings.WorldHeight) {
               ...
               if (i5 == 0) {
                  for(int i6 = m; i6 < n; ++i6) {
                     double d9 = ((double)(i6 + paramInt1 * 16) + (double)0.5F - paramDouble1) / d3;

                     for(int i9 = i3; i9 < i4; ++i9) {
                        double d10 = ((double)(i9 + paramInt2 * 16) + (double)0.5F - paramDouble3) / d3;
                        int i10 = (i6 * 16 + i9) * this.worldSettings.WorldHeight + i2;
                        int i11 = 0;
                        if (d9 * d9 + d10 * d10 < (double)1.0F) {
                           for(int i12 = i2 - 1; i12 >= i1; --i12) {
                              double d11 = ((double)i12 + (double)0.5F - paramDouble2) / d4;
                              if (d11 > -0.7 && d9 * d9 + d11 * d11 + d10 * d10 < (double)1.0F) {
   ...
   protected void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         double d2;
         if (this.worldSettings.evenCaveDistribution) {
            d2 = (double)(this.c.nextInt(this.worldSettings.caveMaxAltitude - this.worldSettings.caveMinAltitude) + this.worldSettings.caveMinAltitude);
         } else {
            d2 = (double)this.c.nextInt(this.c.nextInt(this.worldSettings.caveMaxAltitude - this.worldSettings.caveMinAltitude) + this.worldSettings.caveMinAltitude + 1);
         }
         ...
         if (this.c.nextInt(100) <= this.worldSettings.individualCaveRarity) {
            this.a(this.c.nextLong(), paramInt3, paramInt4, paramArrayOfByte, d1, d2, d3);
            l = true;
         }
         ...
         for(int m = 0; m < k; ++m) {
            ...
            this.a(this.c.nextLong(), paramInt3, paramInt4, paramArrayOfByte, d1, d2, d3, f3, f1, f2, 0, 0, (double)1.0F);
         }
      }
