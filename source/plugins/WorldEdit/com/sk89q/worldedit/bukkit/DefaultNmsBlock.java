...
public class DefaultNmsBlock extends NmsBlock {
   ...
   public static boolean set(World world, Vector position, BaseBlock block) {
      ...
      if (!hasTileEntity(world.getBlockTypeIdAt(position.getBlockX(), position.getBlockY(), position.getBlockZ()))) {
         ...
         if (block instanceof DefaultNmsBlock) {
            ...
            DefaultNmsBlock nmsProxyBlock = new DefaultNmsBlock(block.getId(), block.getData(), block);
            data = nmsProxyBlock.getNmsData(position);
         }
   ...
   public static net.minecraft.server.v1_6_R3.Block getNmsBlock(int type) {
      return type >= 0 && type < net.minecraft.server.v1_6_R3.Block.byId.length ? net.minecraft.server.v1_6_R3.Block.byId[type] : null;
   }
   ...
   public static boolean isValidBlockType(int type) throws NoClassDefFoundError {
      return type == 0 || type >= 1 && type < net.minecraft.server.v1_6_R3.Block.byId.length && net.minecraft.server.v1_6_R3.Block.byId[type] != null;
   }
