...
public class CustomEntityCreeper extends EntityCreeper implements CustomMonster {
   ...
   public CustomEntityCreeper(World world) {
      super(world);
      this.spawnReason = SpawnReason.DEFAULT;
      this.camp = CustomMonster.Camp.bad;
      this.range = (double)32.0F;
      this.speed = 0.2;
   ...
   public void setAi(int ai) {
      ...
      switch (ai) {
         ...
         case 1:
            ...
            this.goalSelector.a(3, new PathfinderGoalAvoidPlayer(this, EntityOcelot.class, 6.0F, (double)1.0F, 1.2));
            this.goalSelector.a(4, new CustomPathfinderGoalMeleeAttack(this, (Class)null, (double)1.0F, false));
            this.targetSelector.a(1, new CustomPathfinderGoalNearestAttackableTarget(this, CustomMonster.class, 0, true));
            this.targetSelector.a(1, new CustomPathfinderGoalNearestAttackableTarget(this, EntityHuman.class, 0, true));
