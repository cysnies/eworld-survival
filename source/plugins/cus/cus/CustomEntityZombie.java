...
public class CustomEntityZombie extends EntityZombie implements CustomMonster {
   ...
   public void setAi(int ai) {
      ...
      switch (ai) {
         ...
         case 1:
            ...
            this.goalSelector.a(2, new CustomPathfinderGoalMeleeAttack(this, CustomMonster.class, (double)1.0F, false));
            this.goalSelector.a(2, new CustomPathfinderGoalMeleeAttack(this, EntityHuman.class, (double)1.0F, false));
         ...
         case 2:
            ...
            this.goalSelector.a(2, new CustomPathfinderGoalMeleeAttack(this, CustomMonster.class, (double)1.0F, false));
            this.goalSelector.a(2, new CustomPathfinderGoalMeleeAttack(this, EntityHuman.class, (double)1.0F, false));
            this.goalSelector.a(4, new PathfinderGoalMoveTowardsRestriction(this, (double)1.0F));
            this.goalSelector.a(6, new PathfinderGoalRandomStroll(this, (double)1.0F));
            this.goalSelector.a(7, new CustomPathfinderGoalLookAtPlayer(this, CustomMonster.class, 8.0F));
            this.goalSelector.a(7, new CustomPathfinderGoalLookAtPlayer(this, EntityHuman.class, 8.0F));
