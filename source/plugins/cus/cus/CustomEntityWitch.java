...
public class CustomEntityWitch extends EntityWitch implements CustomMonster {
   ...
   public void setAi(int ai) {
      ...
      switch (ai) {
         ...
         case 1:
            ...
            this.goalSelector.a(2, new CustomPathfinderGoalArrowAttack(this, (double)1.0F, 60, 10.0F));
         ...
         case 2:
            this.goalSelector.a(1, new PathfinderGoalFloat(this));
            this.goalSelector.a(2, new CustomPathfinderGoalArrowAttack(this, (double)1.0F, 60, 10.0F));
            this.goalSelector.a(2, new PathfinderGoalRandomStroll(this, (double)1.0F));
            this.goalSelector.a(3, new CustomPathfinderGoalLookAtPlayer(this, EntityHuman.class, 8.0F));
            this.goalSelector.a(3, new CustomPathfinderGoalLookAtPlayer(this, CustomMonster.class, 8.0F));
