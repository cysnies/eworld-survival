...
public class CustomEntitySkeleton extends EntitySkeleton implements CustomMonster {
   private CustomPathfinderGoalArrowAttack bp = new CustomPathfinderGoalArrowAttack(this, (double)1.0F, 20, 60, 15.0F);
   private CustomPathfinderGoalMeleeAttack bq = new CustomPathfinderGoalMeleeAttack(this, EntityLiving.class, 1.2, false);
   static Field field1;
   static Field field2;
   ...
   static {
      try {
         field1 = EntitySkeleton.class.getDeclaredField("bq");
      ...
      try {
         field2 = EntitySkeleton.class.getDeclaredField("bp");
   ...
   public CustomEntitySkeleton(World world) {
      ...
      try {
         field1.set(this, this.bq);
         field2.set(this, this.bp);
         this.setAi(2);
   ...
   public void setAi(int ai) {
      ...
      switch (ai) {
         ...
         case 1:
            ...
            this.goalSelector.a(3, new PathfinderGoalFleeSun(this, (double)1.0F));
            this.targetSelector.a(1, new PathfinderGoalHurtByTarget(this, false));
            this.targetSelector.a(2, new CustomPathfinderGoalNearestAttackableTarget(this, CustomMonster.class, 0, true));
         ...
         case 2:
            ...
            this.goalSelector.a(6, new CustomPathfinderGoalLookAtPlayer(this, CustomMonster.class, 8.0F));
            this.goalSelector.a(6, new CustomPathfinderGoalLookAtPlayer(this, EntityHuman.class, 8.0F));
