...
public class CustomEntityChicken extends EntityChicken implements CustomAnimal {
   public CustomEntityChicken(World world) {
      super(world);
   }

   public EntityChicken b(EntityAgeable entityageable) {
      return new CustomEntityChicken(this.world);
   }
   ...
   public void setAi(int ai) {
      ...
      switch (ai) {
         ...
         case 1:
            ...
            this.goalSelector.a(3, new PathfinderGoalTempt(this, (double)1.0F, Item.SEEDS.id, false));
            break;
         case 2:
            this.goalSelector.a(0, new PathfinderGoalFloat(this));
