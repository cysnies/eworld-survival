...
public class iCo5 implements Method {
   ...
   public boolean hasBank(String bank) {
      return this.hasBanks() && com.iConomy.iConomy.Banks.exists(bank);
   }
   ...
   public boolean hasBankAccount(String bank, String name) {
      return this.hasBank(bank) && com.iConomy.iConomy.getBank(bank).hasAccount(name);
   }

   public boolean createAccount(String name) {
      return this.hasAccount(name) ? false : com.iConomy.iConomy.Accounts.create(name);
   }

   public boolean createAccount(String name, Double balance) {
      if (this.hasAccount(name)) {
         return false;
      } else if (!com.iConomy.iConomy.Accounts.create(name)) {
         return false;
      } else {
