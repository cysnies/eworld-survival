...
public class Potions {
   ...
   private static final Map ALIASPOTIONS = new HashMap();
   ...
   public static PotionEffectType getByName(String name) {
      ...
      if (peffect == null) {
         peffect = (PotionEffectType)POTIONS.get(name.toLowerCase(Locale.ENGLISH));
      }

      if (peffect == null) {
         peffect = (PotionEffectType)ALIASPOTIONS.get(name.toLowerCase(Locale.ENGLISH));
      }
