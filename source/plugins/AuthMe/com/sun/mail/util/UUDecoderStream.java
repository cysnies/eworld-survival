               ...
               if (count < 32) {
                  ...
                  if (line.length() >= need + 1) {
                     ...
                     while(this.bufsize < count) {
                        byte a = (byte)(line.charAt(need++) - 32 & 63);
                        byte b = (byte)(line.charAt(need++) - 32 & 63);
                        this.buffer[this.bufsize++] = (byte)(a << 2 & 252 | b >>> 4 & 3);
                        if (this.bufsize < count) {
                           a = b;
                           b = (byte)(line.charAt(need++) - 32 & 63);
                           this.buffer[this.bufsize++] = (byte)(a << 4 & 240 | b >>> 2 & 15);
                        }

                        if (this.bufsize < count) {
                           byte var13 = (byte)(line.charAt(need++) - 32 & 63);
                           this.buffer[this.bufsize++] = (byte)(b << 6 & 192 | var13 & 63);
                        }
                     }
