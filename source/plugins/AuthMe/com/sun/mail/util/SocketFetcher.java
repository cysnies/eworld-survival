      ...
      try {
         ...
         if (useSSL) {
            ...
            if (sfo instanceof SocketFactory) {
               ...
               (new StringBuilder("SSL socket factory instance ")).append(sf).toString();
            }

            if (sf == null) {
               String sfClass = props.getProperty(prefix + ".ssl.socketFactory.class");
               sf = getSocketFactory(sfClass);
               (new StringBuilder("SSL socket factory class ")).append(sfClass).toString();
            }
         ...
         if (sf == null) {
            ...
            if (sfo instanceof SocketFactory) {
               sf = (SocketFactory)sfo;
               (new StringBuilder("socket factory instance ")).append(sf).toString();
            }

            if (sf == null) {
               String sfClass = props.getProperty(prefix + ".socketFactory.class");
               sf = getSocketFactory(sfClass);
               (new StringBuilder("socket factory class ")).append(sfClass).toString();
            }
