...
public class SMTPTransport extends Transport {
   ...
   public boolean sasllogin(String[] allowed, String realm, String authzid, String u, String p) throws MessagingException {
      ...
      try {
         ...
         var9 = this.saslAuthenticator.authenticate(mechs, realm, authzid, u, p);
      } finally {
         this.resumeTracing();
      }
      ...
      if (!(message instanceof MimeMessage)) {
         ...
         if (addresses.length == 0) {
            ...
            try {
               ...
               this.logger.log(Level.FINE, "MessagingException while sending", (Throwable)mex);
               ...
               this.logger.log(Level.FINE, "IOException while sending, closing", (Throwable)ex);
         ...
         switch (retCode) {
            ...
            case 251:
               ...
               if (this.reportSuccess) {
                  MessagingException var26 = new SMTPAddressSucceededException(ia, cmd, retCode, this.lastServerResponse);
                  if (mex == null) {
                     mex = var26;
                  } else {
                     mex.setNextException(var26);
                  }
               }
               break;
            case 450:
            ...
            case 552:
               ...
               MessagingException var25 = new SMTPAddressFailedException(ia, cmd, retCode, this.lastServerResponse);
               if (mex == null) {
                  mex = var25;
               } else {
                  mex.setNextException(var25);
               }
               break;
            case 501:
            case 503:
            ...
            case 553:
               ...
               MessagingException var24 = new SMTPAddressFailedException(ia, cmd, retCode, this.lastServerResponse);
               if (mex == null) {
                  mex = var24;
               } else {
                  mex.setNextException(var24);
               }
               break;
            default:
               ...
               MessagingException var27 = new SMTPAddressFailedException(ia, cmd, retCode, this.lastServerResponse);
               if (mex == null) {
                  mex = var27;
               } else {
                  mex.setNextException(var27);
               }
         }
      }
      ...
      if (sendFailed) {
         ...
         try {
            ...
            try {
               ...
               this.logger.log(Level.FINE, "close failed", (Throwable)ex2);
            }
         } finally {
