...
public class IMAPFolder extends Folder implements UIDFolder, ResponseHandler {
   ...
   public synchronized void open(int mode) throws MessagingException {
      ...
      synchronized(this.messageCacheLock) {
         ...
         } catch (CommandFailedException var54) {
            CommandFailedException cex = var54;
   ...
   public synchronized void fetch(Message[] msgs, FetchProfile fp) throws MessagingException {
      ...
      if (fp.contains(FetchProfile.Item.SIZE) || fp.contains((FetchProfile.Item)IMAPFolder.FetchProfileItem.SIZE)) {
      ...
      synchronized(this.messageCacheLock) {
         ...
         if (msgsets != null) {
            ...
            try {
               ...
               throw new FolderClosedException(this, cex.getMessage());
            } catch (CommandFailedException var21) {
            } catch (ProtocolException pex) {
               throw new MessagingException(pex.getMessage(), pex);
            }
   ...
   public synchronized int getMessageCount() throws MessagingException {
      if (!this.opened) {
         ...
         try {
            Status status = this.getStatus();
            return status.total;
         } catch (BadCommandException var16) {
            IMAPProtocol p = null;
